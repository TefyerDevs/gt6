...
import com.gregtechceu.gt6.api.data.medicalcondition.Symptom;
import com.gregtechceu.gt6.api.data.tag.TagPrefix;
import com.gregtechceu.gt6.api.data.worldgen.*;
import com.gregtechceu.gt6.api.data.worldgen.generator.IndicatorGenerator;
import com.gregtechceu.gt6.api.data.worldgen.generator.VeinGenerator;
import com.gregtechceu.gt6.api.data.worldgen.generator.indicators.SurfaceIndicatorGenerator.IndicatorPlacement;
import com.gregtechceu.gt6.api.data.worldgen.generator.veins.DikeVeinGenerator;
...
import com.gregtechceu.gt6.api.item.tool.ToolHelper;
...
import com.gregtechceu.gt6.api.recipe.DummyCraftingContainer;
import com.gregtechceu.gt6.api.recipe.GTRecipe;
import com.gregtechceu.gt6.api.recipe.GTRecipeSerializer;
import com.gregtechceu.gt6.api.recipe.GTRecipeType;
import com.gregtechceu.gt6.api.recipe.OverclockingLogic;
...
import com.gregtechceu.gt6.common.cosmetics.GTCapes;
import com.gregtechceu.gt6.common.data.*;
import com.gregtechceu.gt6.common.data.machines.GCYMMachines;
...
import com.gregtechceu.gt6.common.item.armor.PowerlessJetpack;
import com.gregtechceu.gt6.common.machine.multiblock.primitive.PrimitiveFancyUIWorkableMachine;
import com.gregtechceu.gt6.common.registry.GTRegistration;
import com.gregtechceu.gt6.common.unification.material.MaterialRegistryManager;
import com.gregtechceu.gt6.core.mixins.IngredientAccessor;
import com.gregtechceu.gt6.data.pack.GTDynamicResourcePack;
import com.gregtechceu.gt6.data.recipe.CraftingComponent;
import com.gregtechceu.gt6.data.recipe.GTCraftingComponents;
import com.gregtechceu.gt6.data.recipe.builder.GTRecipeBuilder;
import com.gregtechceu.gt6.data.recipe.misc.RecyclingRecipes;
import com.gregtechceu.gt6.integration.kjs.builders.*;
import com.gregtechceu.gt6.integration.kjs.builders.block.ActiveBlockBuilder;
import com.gregtechceu.gt6.integration.kjs.builders.block.CoilBlockBuilder;
import com.gregtechceu.gt6.integration.kjs.builders.machine.*;
import com.gregtechceu.gt6.integration.kjs.builders.prefix.BasicTagPrefixBuilder;
import com.gregtechceu.gt6.integration.kjs.builders.prefix.OreTagPrefixBuilder;
import com.gregtechceu.gt6.integration.kjs.helpers.MachineConstructors;
import com.gregtechceu.gt6.integration.kjs.helpers.MachineModifiers;
import com.gregtechceu.gt6.integration.kjs.helpers.MaterialStackWrapper;
import com.gregtechceu.gt6.integration.kjs.recipe.GTRecipeSchema;
import com.gregtechceu.gt6.integration.kjs.recipe.GTShapedRecipeSchema;
import com.gregtechceu.gt6.integration.kjs.recipe.KJSHelpers;
import com.gregtechceu.gt6.integration.kjs.recipe.WrappingRecipeSchemaType;
import com.gregtechceu.gt6.integration.kjs.recipe.components.ExtendedOutputItem;
import com.gregtechceu.gt6.integration.kjs.recipe.components.GTRecipeComponents;
import com.gregtechceu.gt6.utils.data.RuntimeBlockStateProvider;
...
public class GregTechKubeJSPlugin extends KubeJSPlugin {
    ...
    public void init() {
        ...
        RegistryInfo.BLOCK.addType("gt6:active", ActiveBlockBuilder.class, ActiveBlockBuilder::new);
        RegistryInfo.BLOCK.addType("gt6:coil", CoilBlockBuilder.class, CoilBlockBuilder::new);
    }
    ...
    public void registerClasses(ScriptType type, ClassFilter filter) {
        ...
        // allow user to access all gt6 classes by importing them.
        filter.allow("com.gregtechceu.gt6");
        filter.deny("com.gregtechceu.gt6.core");
        filter.deny("com.gregtechceu.gt6.common.network");
    }
