...
public class CoverProvider extends CapabilityInfoProvider<ICoverable> {
    ...
    // String unit = " {*gt6.top.unit.items*}";
    //
    ...
    // String unit = voiding.getBucketMode() == CoverPump.BucketMode.BUCKET ? " {*gt6.top.unit.fluid_buckets*}" : "
    // {*gt6.top.unit.fluid_milibuckets*}";
    //
    ...
    // probeInfo.text(TextStyleClass.INFO + "{*gt6.top.link_cover.color*} " + enderFluidLink.getColorStr());
    // }
    // }
    //
    //
    ...
    // rateUnit, int rate) {
    // String modeText = mode.isImport() ? "{*gt6.top.mode.import*} " : "{*gt6.top.mode.export*} ";
    ...
    // String label = TextStyleClass.INFO + "{*gt6.top.filter.label*} ";
