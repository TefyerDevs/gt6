    ...
    public void getTooltip(int slotIndex, List<Component> tooltips) {
        if (chances.containsKey(slotIndex)) {
            ...
            if (entry.tierChanceBoost != 0) {
                ...
                tooltips.add(FormattingUtil.formatPercentage2Places("gt6.gui.content.chance_base", chance));
                tooltips.add(FormattingUtil.formatPercentage2Places("gt6.gui.content.chance_tier_boost_plus", boost));
            } else {
                tooltips.add(FormattingUtil.formatPercentage2Places("gt6.gui.content.chance_no_boost", chance));
            }
        }
    }
