package com.gregtechceu.gt6.integration.map.cache.client;
...
import com.gregtechceu.gt6.integration.map.GroupingMapRenderer;
import com.gregtechceu.gt6.integration.map.cache.DimensionCache;
import com.gregtechceu.gt6.integration.map.cache.GridCache;
import com.gregtechceu.gt6.integration.map.cache.WorldCache;
import com.gregtechceu.gt6.integration.map.cache.fluid.FluidCache;
...
public class GTClientCache extends WorldCache implements IClientCache {
    ...
    public void notifyNewVeins(GeneratedVeinMetadata... veins) {
        ...
        for (var vein : veins) {
            ...
            var name = Component.translatable(veinId.replace("gt6:", "gt6.jei.ore_vein."));
            ...
            player.sendSystemMessage(Component.translatable("message.gt6.new_veins.name", name));
        }
    }
