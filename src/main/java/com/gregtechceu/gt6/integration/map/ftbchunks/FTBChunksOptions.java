package com.gregtechceu.gt6.integration.map.ftbchunks;
...
public class FTBChunksOptions {
    ...
    private static final SNBTConfig CONFIG = SNBTConfig.create("gt6");
    ...
    public static void loadConfig() {
        ConfigUtil.loadDefaulted(CONFIG, ConfigUtil.LOCAL_DIR.resolve("gt6"), "gt6", "client-config.snbt");
    }

    public static void saveConfig() {
        CONFIG.save(ConfigUtil.LOCAL_DIR.resolve("gt6").resolve("client-config.snbt"));
    }
}
