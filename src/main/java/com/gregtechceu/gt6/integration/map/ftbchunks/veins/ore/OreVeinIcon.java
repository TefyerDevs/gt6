package com.gregtechceu.gt6.integration.map.ftbchunks.veins.ore;
...
import com.gregtechceu.gt6.client.util.DrawUtil;
...
public class OreVeinIcon implements MapIcon {
    ...
    private void openContextMenu(LargeMapScreen screen) {
        ...
        var markDepleted = new ContextMenuItem(Component.translatable("button.gt6.mark_as_depleted.name"),
                Icons.REMOVE,
        ...
        var toggleWaypoint = new ContextMenuItem(Component.translatable("button.gt6.toggle_waypoint.name"),
                waypointIcon,
