package com.gregtechceu.gt6.integration.map.xaeros.worldmap.ore;
...
public class OreVeinElementReader extends
    ...
    public ArrayList<RightClickOption> getRightClickOptions(final OreVeinElement element,
        ...
        rightClickOptions.add(new RightClickOption("button.gt6.toggle_waypoint.name", 0, target) {
        ...
        rightClickOptions
                .add((new RightClickOption("button.gt6.mark_as_depleted.name", rightClickOptions.size(), target) {
