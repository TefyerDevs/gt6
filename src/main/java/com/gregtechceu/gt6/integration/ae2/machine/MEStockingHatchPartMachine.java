...
import com.gregtechceu.gt6.api.gui.fancy.TabsWidget;
import com.gregtechceu.gt6.api.machine.IMachineBlockEntity;
import com.gregtechceu.gt6.api.machine.MetaMachine;
import com.gregtechceu.gt6.api.machine.fancyconfigurator.AutoStockingFancyConfigurator;
...
import com.gregtechceu.gt6.integration.ae2.slot.ExportOnlyAEFluidList;
import com.gregtechceu.gt6.integration.ae2.slot.ExportOnlyAEFluidSlot;
import com.gregtechceu.gt6.integration.ae2.slot.ExportOnlyAESlot;
import com.gregtechceu.gt6.integration.ae2.slot.IConfigurableSlotList;
import com.gregtechceu.gt6.integration.ae2.utils.AEUtil;
        ...
        if (!isRemote()) {
            ...
            if (autoPull) {
                playerIn.sendSystemMessage(
                        Component.translatable("gt6.machine.me.stocking_auto_pull_enabled"));
            } else {
                playerIn.sendSystemMessage(
                        Component.translatable("gt6.machine.me.stocking_auto_pull_disabled"));
            }
        }
