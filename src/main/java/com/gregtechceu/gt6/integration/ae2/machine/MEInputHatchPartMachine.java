...
import com.gregtechceu.gt6.api.machine.feature.IHasCircuitSlot;
...
import com.gregtechceu.gt6.integration.ae2.gui.widget.AEFluidConfigWidget;
...
public class MEInputHatchPartMachine extends MEHatchPartMachine
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new LabelWidget(3, 0, () -> this.isOnline ?
                "gt6.gui.me_network.online" :
                "gt6.gui.me_network.offline"));
    ...
    public final InteractionResult onDataStickShiftUse(Player player, ItemStack dataStick) {
        if (!isRemote()) {
            ...
            dataStick.setHoverName(Component.translatable("gt6.machine.me.fluid_import.data_stick.name"));
            player.sendSystemMessage(Component.translatable("gt6.machine.me.import_copy_settings"));
        }
    ...
    public final InteractionResult onDataStickUse(Player player, ItemStack dataStick) {
        ...
        if (!isRemote()) {
            ...
            this.updateTankSubscription();
            player.sendSystemMessage(Component.translatable("gt6.machine.me.import_paste_settings"));
        }
