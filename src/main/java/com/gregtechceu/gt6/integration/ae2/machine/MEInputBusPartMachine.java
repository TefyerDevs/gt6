...
import com.gregtechceu.gt6.integration.ae2.gui.widget.AEItemConfigWidget;
import com.gregtechceu.gt6.integration.ae2.slot.ExportOnlyAEItemList;
import com.gregtechceu.gt6.integration.ae2.slot.ExportOnlyAEItemSlot;
...
public class MEInputBusPartMachine extends MEBusPartMachine
    ...
    public final InteractionResult onDataStickShiftUse(Player player, ItemStack dataStick) {
        if (!isRemote()) {
            ...
            dataStick.setHoverName(Component.translatable("gt6.machine.me.item_import.data_stick.name"));
