package com.gregtechceu.gt6.integration.ae2.gui.widget.slot;

import com.gregtechceu.gt6.integration.ae2.gui.widget.ConfigWidget;
import com.gregtechceu.gt6.integration.ae2.slot.IConfigurableSlot;
    ...
    public void drawInForeground(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (slot.getConfig() == null) {
            if (mouseOverConfig(mouseX, mouseY)) {
                ...
                hoverStringList.add(Component.translatable("gt6.gui.config_slot"));
                if (parentWidget.isAutoPull()) {
                    hoverStringList.add(Component.translatable("gt6.gui.config_slot.auto_pull_managed"));
                } else {
                    if (!parentWidget.isStocking()) {
                        hoverStringList.add(Component.translatable("gt6.gui.config_slot.set"));
                        hoverStringList.add(Component.translatable("gt6.gui.config_slot.scroll"));
                    } else {
                        hoverStringList.add(Component.translatable("gt6.gui.config_slot.set_only"));
                    }
                    hoverStringList.add(Component.translatable("gt6.gui.config_slot.remove"));
                }
