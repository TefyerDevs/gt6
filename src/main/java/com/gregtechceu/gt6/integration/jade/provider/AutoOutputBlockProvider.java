    ...
    public void appendTooltip(ITooltip iTooltip, BlockAccessor blockAccessor, IPluginConfig iPluginConfig) {
        ...
        if (be != null) {
            ...
            if (data.contains("autoOutputItem", Tag.TAG_COMPOUND)) {
                ...
                addAutoOutputInfo(iTooltip, blockAccessor, tag, "gt6.top.item_auto_output");
            }

            if (data.contains("autoOutputFluid", Tag.TAG_COMPOUND)) {
                var tag = data.getCompound("autoOutputFluid");
                addAutoOutputInfo(iTooltip, blockAccessor, tag, "gt6.top.fluid_auto_output");
            }
        }
    }
    ...
    private void addAutoOutputInfo(ITooltip iTooltip, BlockAccessor blockAccessor, CompoundTag compoundTag,
        ...
        if (direction != null) {
            ...
            if (allowInput || auto) {
                ...
                if (auto) {
                    component.append(Component.translatable("gt6.top.auto_output"));
                }
                ...
                if (allowInput) {
                    component.append(Component.translatable("gt6.top.allow_output_input"));
                }
                component.append(")");
