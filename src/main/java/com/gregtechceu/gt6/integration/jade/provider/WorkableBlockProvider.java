...
public class WorkableBlockProvider extends CapabilityBlockProvider<IWorkable> {
    ...
    protected void addTooltip(CompoundTag capData, ITooltip tooltip, Player player, BlockAccessor block,
        ...
        if (capData.getBoolean("Research")) {
            ...
            text = Component.translatable("gt6.jade.progress_computation", current, max);
        ...
        if (maxProgress < 20) {
            text = Component.translatable("gt6.jade.progress_tick", currentProgress, maxProgress);
        } else {
            text = Component.translatable("gt6.jade.progress_sec", Math.round(currentProgress / 20.0F),
