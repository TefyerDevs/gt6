package com.gregtechceu.gt6.integration.emi.recipe;
        ...
        for (com.lowdragmc.lowdraglib.gui.widget.Widget w : getFlatWidgetCollection(widget)) {
            if (w instanceof IRecipeIngredientSlot slot) {
                ...
                if (io != null && io != IngredientIO.RENDER_ONLY) {
                    ...
                    if (slot instanceof com.gregtechceu.gt6.api.gui.widget.SlotWidget slotW) {
                    ...
                    } else if (slot instanceof com.gregtechceu.gt6.api.gui.widget.TankWidget tankW) {
