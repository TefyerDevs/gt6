package com.gregtechceu.gt6.client.forge;
...
import com.gregtechceu.gt6.client.renderer.BlockHighlightRenderer;
import com.gregtechceu.gt6.client.renderer.MultiblockInWorldPreviewRenderer;
import com.gregtechceu.gt6.client.renderer.cover.FacadeCoverRenderer;
import com.gregtechceu.gt6.client.util.TooltipHelper;
import com.gregtechceu.gt6.common.commands.GTClientCommands;
import com.gregtechceu.gt6.core.mixins.client.AbstractClientPlayerAccessor;
import com.gregtechceu.gt6.core.mixins.client.PlayerInfoAccessor;
...
public class ForgeClientEventListener {
    ...
    public static void onPlayerRender(RenderPlayerEvent.Pre event) {
        ...
        if (clientPlayer.gt6$getPlayerInfo() != null) {
            PlayerInfoAccessor playerInfo = ((PlayerInfoAccessor) clientPlayer.gt6$getPlayerInfo());
