...
public class InputSlotCrafterMixin {
    ...
    @WrapOperation(method = "areItemsEqual",
                   at = @At(value = "INVOKE",
                            ...
                            remap = true))
    private static boolean gt6$modifyFindSlotMatcherREI(ItemStack stack, ItemStack other,
    ...
    @WrapOperation(method = "takeInventoryStack",
                   at = @At(value = "INVOKE",
                            ...
                            remap = true))
    private boolean gt6$damagedToolBypass(ItemStack instance, Operation<Boolean> original) {
    ...
    @WrapOperation(method = "takeInventoryStack",
                   at = @At(value = "INVOKE",
                            ...
                            remap = true))
    private boolean gt6$enchantedToolBypass(ItemStack instance, Operation<Boolean> original) {
        if (instance.getItem() instanceof IGTTool) {
            return false;
        }
        return original.call(instance);
