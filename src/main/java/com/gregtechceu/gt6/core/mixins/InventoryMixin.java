...
public abstract class InventoryMixin {
    ...
    private boolean gt6$ignoreGTToolNbt(ItemStack stack, ItemStack other, Operation<Boolean> original) {
    ...
    private boolean gt6$ignoreGTToolDamage(ItemStack instance, Operation<Boolean> original) {
    ...
    private boolean gt6$ignoreGTToolEnchants(ItemStack instance, Operation<Boolean> original) {
        if (instance.getItem() instanceof IGTTool) {
            return false;
        }
        return original.call(instance);
