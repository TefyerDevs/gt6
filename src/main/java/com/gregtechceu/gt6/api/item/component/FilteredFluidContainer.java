...
import com.gregtechceu.gt6.api.misc.forge.FilteredFluidHandlerItemStack;
...
public class FilteredFluidContainer implements IItemComponent, IComponentCapability, IAddInformation {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents,
        ...
        FluidUtil.getFluidContained(stack).ifPresent(fluid -> tooltipComponents
                .add(Component.translatable("gt6.universal.tooltip.fluid_stored", fluid.getDisplayName(),
                        fluid.getAmount())));
    }
}
