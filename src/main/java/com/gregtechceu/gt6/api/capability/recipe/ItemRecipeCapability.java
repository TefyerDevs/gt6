...
import com.gregtechceu.gt6.api.machine.trait.RecipeHandlerGroupDistinctness;
...
import com.gregtechceu.gt6.api.recipe.ResearchData;
import com.gregtechceu.gt6.api.recipe.content.Content;
import com.gregtechceu.gt6.api.recipe.content.ContentModifier;
import com.gregtechceu.gt6.api.recipe.content.SerializerIngredient;
import com.gregtechceu.gt6.api.recipe.ingredient.IntCircuitIngredient;
import com.gregtechceu.gt6.api.recipe.ingredient.IntProviderIngredient;
...
import com.gregtechceu.gt6.api.recipe.ui.GTRecipeTypeUI;
...
import com.gregtechceu.gt6.common.valueprovider.MultipliedFloat;
...
import com.gregtechceu.gt6.core.mixins.forge.IntersectionIngredientAccessor;
import com.gregtechceu.gt6.integration.xei.entry.item.ItemEntryList;
import com.gregtechceu.gt6.integration.xei.entry.item.ItemStackList;
import com.gregtechceu.gt6.integration.xei.entry.item.ItemTagList;
import com.gregtechceu.gt6.integration.xei.handlers.item.CycleItemEntryHandler;
import com.gregtechceu.gt6.integration.xei.handlers.item.CycleItemStackHandler;
import com.gregtechceu.gt6.integration.xei.widgets.GTRecipeWidget;
import com.gregtechceu.gt6.utils.*;
...
import static com.gregtechceu.gt6.api.recipe.RecipeHelper.addToRecipeHandlerMap;
            ...
            if (content != null) {
                ...
                slot.setOnAddedTooltips((w, tooltips) -> {
                    ...
                    if (this.of(content.content) instanceof IntProviderIngredient ingredient) {
                        ...
                        tooltips.add(Component.translatable("gt6.gui.content.count_range",
                    ...
                    if (isTickSlot(index, io, recipe)) {
                        tooltips.add(Component.translatable("gt6.gui.content.per_tick"));
                    }
                });
