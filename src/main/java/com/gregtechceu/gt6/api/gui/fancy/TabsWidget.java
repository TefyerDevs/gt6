...
public class TabsWidget extends Widget {
    ...
    @Setter
    protected IGuiTexture tabTexture = new ResourceTexture("gt6:textures/gui/tab/tabs_top.png").getSubTexture(1 / 3f,
            0, 1 / 3f, 0.5f);
    @Setter
    protected IGuiTexture tabHoverTexture = new ResourceTexture("gt6:textures/gui/tab/tabs_top.png")
