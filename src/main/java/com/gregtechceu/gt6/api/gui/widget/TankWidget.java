...
import com.gregtechceu.gt6.integration.xei.handlers.fluid.CycleFluidStackHandler;
    ...
    public List<Component> getFullTooltipTexts() {
        ...
        if (fluidStack != null && !fluidStack.isEmpty()) {
            ...
            if (!isPhantom && showAmount) {
                tooltips.add(
                        Component.translatable("gt6.fluid.amount",
            ...
            tooltips.add(Component.translatable("gt6.fluid.empty"));
            if (!isPhantom && showAmount) {
                tooltips.add(Component.translatable("gt6.fluid.amount", 0,
                        FormattingUtil.formatNumbers(lastTankCapacity)));
            }
        }
