package com.gregtechceu.gt6.api.gui;
...
public class GuiTextures {
    ...
    public static final ResourceTexture GREGTECH_LOGO = new ResourceTexture(
            "gt6:textures/gui/icon/gregtech_logo.png");
    public static final ResourceTexture GREGTECH_LOGO_XMAS = new ResourceTexture(
            "gt6:textures/gui/icon/gregtech_logo_xmas.png");

    // HUD
    public static final ResourceTexture TOOL_FRONT_FACING_ROTATION = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_front_facing_rotation.png");
    public static final ResourceTexture TOOL_IO_FACING_ROTATION = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_io_facing_rotation.png");
    public static final ResourceTexture TOOL_PAUSE = new ResourceTexture("gt6:textures/gui/overlay/tool_pause.png");
    public static final ResourceTexture TOOL_START = new ResourceTexture("gt6:textures/gui/overlay/tool_start.png");
    public static final ResourceTexture TOOL_COVER_SETTINGS = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_cover_settings.png");
    public static final ResourceTexture TOOL_MUTE = new ResourceTexture("gt6:textures/gui/overlay/tool_mute.png");
    public static final ResourceTexture TOOL_SOUND = new ResourceTexture("gt6:textures/gui/overlay/tool_sound.png");
    public static final ResourceTexture TOOL_ALLOW_INPUT = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_allow_input.png");
    public static final ResourceTexture TOOL_ATTACH_COVER = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_attach_cover.png");
    public static final ResourceTexture TOOL_REMOVE_COVER = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_remove_cover.png");
    public static final ResourceTexture TOOL_PIPE_BLOCK = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_pipe_block.png");
    public static final ResourceTexture TOOL_PIPE_CONNECT = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_pipe_connect.png");
    public static final ResourceTexture TOOL_WIRE_BLOCK = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_wire_block.png");
    public static final ResourceTexture TOOL_WIRE_CONNECT = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_wire_connect.png");
    public static final ResourceTexture TOOL_AUTO_OUTPUT = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_auto_output.png");
    public static final ResourceTexture TOOL_DISABLE_AUTO_OUTPUT = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_disable_auto_output.png");
    public static final ResourceTexture TOOL_SWITCH_CONVERTER_NATIVE = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_wire_block.png"); // todo switch to tool_switch_converter_native once that
                                                               // gets made
    public static final ResourceTexture TOOL_SWITCH_CONVERTER_EU = new ResourceTexture(
            "gt6:textures/gui/overlay/tool_wire_connect.png"); // todo switch to tool_switch_converter_eu once that
                                                                 // gets made

    // BASE TEXTURES
    public static final ResourceBorderTexture BACKGROUND = new ResourceBorderTexture(
            "gt6:textures/gui/base/background.png", 16, 16, 4, 4);
    public static final ResourceBorderTexture BACKGROUND_INVERSE = new ResourceBorderTexture(
            "gt6:textures/gui/base/background_inverse.png", 16, 16, 4, 4);
    public static final SteamTexture BACKGROUND_STEAM = SteamTexture
            .fullImage("gt6:textures/gui/base/background_%s.png");
    public static final ResourceTexture CLIPBOARD_BACKGROUND = new ResourceTexture(
            "gt6:textures/gui/base/clipboard_background.png");
    public static final ResourceTexture CLIPBOARD_PAPER_BACKGROUND = new ResourceTexture(
            "gt6:textures/gui/base/clipboard_paper_background.png");
    public static final ResourceBorderTexture TITLE_BAR_BACKGROUND = new ResourceBorderTexture(
            "gt6:textures/gui/base/title_bar_background.png", 16, 16, 4, 4);

    public static final ResourceTexture DISPLAY = new ResourceTexture("gt6:textures/gui/base/display.png");
    public static final SteamTexture DISPLAY_STEAM = SteamTexture.fullImage("gt6:textures/gui/base/display_%s.png");
    public static final ResourceTexture BLANK = new ResourceBorderTexture("gt6:textures/gui/base/blank.png", 1, 1, 0,
            0);
    public static final ResourceTexture BLANK_TRANSPARENT = new ResourceBorderTexture(
            "gt6:textures/gui/base/blank_transparent.png", 1, 1, 0, 0);
    public static final ResourceBorderTexture FLUID_SLOT = new ResourceBorderTexture(
            "gt6:textures/gui/base/fluid_slot.png", 18, 18, 1, 1);
    public static final ResourceTexture FLUID_TANK_BACKGROUND = new ResourceTexture(
            "gt6:textures/gui/base/fluid_tank_background.png");
    public static final ResourceTexture FLUID_TANK_OVERLAY = new ResourceTexture(
            "gt6:textures/gui/base/fluid_tank_overlay.png");
    public static final ResourceBorderTexture SLOT = new ResourceBorderTexture("gt6:textures/gui/base/slot.png", 18,
            18, 1, 1);
    public static final ResourceBorderTexture SLOT_DARK = new ResourceBorderTexture(
            "gt6:textures/gui/base/slot_dark.png", 18,
            18, 1, 1);

    public static final ResourceTexture SLOT_DARKENED = new ResourceTexture(
            "gt6:textures/gui/base/darkened_slot.png");
    public static final SteamTexture SLOT_STEAM = SteamTexture.fullImage("gt6:textures/gui/base/slot_%s.png");
    public static final ResourceTexture TOGGLE_BUTTON_BACK = new ResourceTexture(
            "gt6:textures/gui/widget/toggle_button_background.png");

    public static final ResourceTexture CLOSE_ICON = new ResourceTexture("gt6:textures/gui/icon/close.png");

    // FLUID & ITEM OUTPUT BUTTONS
    public static final ResourceTexture BLOCKS_INPUT = new ResourceTexture(
            "gt6:textures/gui/widget/button_blocks_input.png");
    public static final ResourceBorderTexture BUTTON = new ResourceBorderTexture("gt6:textures/gui/widget/button.png",
            32, 32, 2, 2);
    public static final ResourceTexture BUTTON_ALLOW_IMPORT_EXPORT = new ResourceTexture(
            "gt6:textures/gui/widget/button_allow_import_export.png");
    public static final ResourceTexture BUTTON_BLACKLIST = new ResourceTexture(
            "gt6:textures/gui/widget/button_blacklist.png");
    public static final ResourceTexture BUTTON_CHUNK_MODE = new ResourceTexture(
            "gt6:textures/gui/widget/button_chunk_mode.png");
    public static final ResourceTexture BUTTON_CLEAR_GRID = new ResourceTexture(
            "gt6:textures/gui/widget/button_clear_grid.png");
    public static final ResourceTexture BUTTON_FILTER_DAMAGE = new ResourceTexture(
            "gt6:textures/gui/widget/button_filter_damage.png");
    public static final ResourceTexture BUTTON_DISTINCT_BUSES = new ResourceTexture(
            "gt6:textures/gui/widget/button_distinct_buses.png");
    public static final ResourceTexture BUTTON_POWER = new ResourceTexture(
            "gt6:textures/gui/widget/button_power.png");
    public static final ResourceTexture BUTTON_BATCH = new ResourceTexture(
            "gt6:textures/gui/widget/button_batch.png");
    public static final ResourceTexture BUTTON_FILTER_NBT = new ResourceTexture(
            "gt6:textures/gui/widget/button_filter_nbt.png");
    public static final ResourceTexture BUTTON_FLUID_OUTPUT = new ResourceTexture(
            "gt6:textures/gui/widget/button_fluid_output_overlay.png");
    public static final ResourceTexture BUTTON_ITEM_OUTPUT = new ResourceTexture(
            "gt6:textures/gui/widget/button_item_output_overlay.png");
    public static final ResourceTexture BUTTON_LOCK = new ResourceTexture("gt6:textures/gui/widget/button_lock.png");
    public static final ResourceTexture BUTTON_VOID = new ResourceTexture("gt6:textures/gui/widget/button_void.png");
    public static final ResourceTexture BUTTON_VOID_PARTIAL = new ResourceTexture(
            "gt6:textures/gui/widget/button_void_partial.png");
    public static final ResourceTexture BUTTON_VOID_MULTIBLOCK = new ResourceTexture(
            "gt6:textures/gui/widget/button_void_multiblock.png");
    public static final ResourceTexture BUTTON_LEFT = new ResourceTexture("gt6:textures/gui/widget/left.png");
    public static final ResourceTexture BUTTON_PUBLIC_PRIVATE = new ResourceTexture(
            "gt6:textures/gui/widget/button_public_private.png");
    public static final ResourceTexture BUTTON_CHECK = new ResourceTexture(
            "gt6:textures/gui/widget/button_check.png");
    public static final ResourceTexture BUTTON_LIST = new ResourceTexture(
            "gt6:textures/gui/widget/button_list.png");
    public static final ResourceTexture BUTTON_RIGHT = new ResourceTexture("gt6:textures/gui/widget/right.png");
    public static final ResourceTexture BUTTON_SILK_TOUCH_MODE = new ResourceTexture(
            "gt6:textures/gui/widget/button_silk_touch_mode.png");
    public static final ResourceTexture BUTTON_SWITCH_VIEW = new ResourceTexture(
            "gt6:textures/gui/widget/button_switch_view.png");
    public static final ResourceTexture BUTTON_WORKING_ENABLE = new ResourceTexture(
            "gt6:textures/gui/widget/button_working_enable.png");
    public static final ResourceTexture BUTTON_INT_CIRCUIT_PLUS = new ResourceTexture(
            "gt6:textures/gui/widget/button_circuit_plus.png");
    public static final ResourceTexture BUTTON_INT_CIRCUIT_MINUS = new ResourceTexture(
            "gt6:textures/gui/widget/button_circuit_minus.png");
    public static final ResourceTexture CLIPBOARD_BUTTON = new ResourceTexture(
            "gt6:textures/gui/widget/clipboard_button.png");
    public static final ResourceBorderTexture CLIPBOARD_TEXT_BOX = new ResourceBorderTexture(
            "gt6:textures/gui/widget/clipboard_text_box.png", 9, 18, 1, 1);
    public static final ResourceTexture DISTRIBUTION_MODE = new ResourceTexture(
            "gt6:textures/gui/widget/button_distribution_mode.png");
    public static final ResourceTexture BUTTON_AUTO_PULL = new ResourceTexture(
            "gt6:textures/gui/widget/button_me_auto_pull.png");
    public static final ResourceTexture LOCK = new ResourceTexture("gt6:textures/gui/widget/lock.png");
    public static final ResourceTexture LOCK_WHITE = new ResourceTexture("gt6:textures/gui/widget/lock_white.png");
    public static final ResourceTexture SWITCH = new ResourceTexture("gt6:textures/gui/widget/switch.png");
    public static final ResourceTexture SWITCH_HORIZONTAL = new ResourceTexture(
            "gt6:textures/gui/widget/switch_horizontal.png");
    ...
    public static final ResourceBorderTexture ENERGY_BAR_BACKGROUND = new ResourceBorderTexture(
            "gt6:textures/gui/progress_bar/progress_bar_boiler_empty_steel.png", 10, 54, 1, 1);
    public static final ResourceBorderTexture ENERGY_BAR_BASE = new ResourceBorderTexture(
            "gt6:textures/gui/progress_bar/progress_bar_boiler_heat.png", 10, 54, 1, 1);
    public static final ResourceTexture LIGHT_ON = new ResourceTexture("gt6:textures/gui/widget/light_on.png");
    public static final ResourceTexture LIGHT_OFF = new ResourceTexture("gt6:textures/gui/widget/light_off.png");
    public static final ResourceTexture UP = new ResourceTexture("gt6:textures/gui/base/up.png");
    public static final ResourceTexture[] TIER = new ResourceTexture[9];
    static {
        var offset = 1f / TIER.length;
        for (int i = 0; i < TIER.length; i++) {
            TIER[i] = new ResourceTexture("gt6:textures/gui/overlay/tier.png").getSubTexture(0, i * offset, 1,
                    offset);
        }
    }
