...
import com.gregtechceu.gt6.api.recipe.lookup.GTRecipeLookup;
import com.gregtechceu.gt6.api.recipe.lookup.ingredient.MapIngredientTypeManager;
...
public class SmartItemFilter implements ItemFilter {
    ...
    private enum SmartFilteringMode implements EnumSelectorWidget.SelectableEnum {
        ...
        public IGuiTexture getIcon() {
            return new ResourceTexture("gt6:textures/block/machines/" + localeName + "/overlay_front.png");
        }
    }
}
