...
import com.gregtechceu.gt6.api.gui.fancy.IFancyCustomMiddleClickAction;
import com.gregtechceu.gt6.api.gui.fancy.IFancyCustomMouseWheelAction;
...
public class CircuitFancyConfigurator implements IFancyConfigurator, IFancyCustomMouseWheelAction,
    ...
    public Component getTitle() {
        return Component.translatable("gt6.gui.circuit.title");
    }
    ...
    public List<Component> getTooltips() {
        ...
        list.addAll(Arrays.stream(
                LangHandler.getMultiLang("gt6.gui.configurator_slot.tooltip").toArray(new MutableComponent[0]))
                .toList());
        return list;
    }
