...
import com.gregtechceu.gt6.api.capability.IToolable;
...
import com.gregtechceu.gt6.api.item.tool.IToolGridHighlight;
...
import com.gregtechceu.gt6.api.misc.IOFilteredInvWrapper;
import com.gregtechceu.gt6.api.misc.IOFluidHandlerList;
...
import com.gregtechceu.gt6.common.cover.FluidFilterCover;
import com.gregtechceu.gt6.common.cover.ItemFilterCover;
import com.gregtechceu.gt6.common.item.tool.behavior.ToolModeSwitchBehavior;
import com.gregtechceu.gt6.common.machine.owner.MachineOwner;
import com.gregtechceu.gt6.common.machine.owner.PlayerOwner;
...
import static com.gregtechceu.gt6.api.item.tool.ToolHelper.getBehaviorsTag;
        ...
        if (this instanceof IMufflableMachine mufflableMachine) {
            if (!isRemote()) {
                ...
                playerIn.sendSystemMessage(Component.translatable(mufflableMachine.isMuffled() ?
                        "gt6.machine.muffle.on" : "gt6.machine.muffle.off"));
            }
            ...
            if (this instanceof IAutoOutputItem autoOutputItem) {
                if (autoOutputItem.getOutputFacingItems() == gridSide) {
                    ...
                    playerIn.displayClientMessage(Component
                            .translatable("gt6.machine.basic.input_from_output_side." +
                                    (autoOutputItem.isAllowInputFromOutputSideItems() ? "allow" : "disallow"))
                            .append(Component.translatable("gt6.creative.chest.item")), true);
                    changed = true;
                }
            }
            if (this instanceof IAutoOutputFluid autoOutputFluid) {
                if (autoOutputFluid.getOutputFacingFluids() == gridSide) {
                    ...
                    playerIn.displayClientMessage(Component
                            ...
                            .append(Component.translatable("gt6.creative.tank.fluid")), true);
                    changed = true;
                }
            }
            if (changed) {
