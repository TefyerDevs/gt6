...
public class TieredIOPartMachine extends TieredPartMachine implements IControllable {
    ...
    public PageGroupingData getPageGroupingData() {
        return switch (this.io) {
            case IN -> new PageGroupingData("gt6.multiblock.page_switcher.io.import", 1);
            case OUT -> new PageGroupingData("gt6.multiblock.page_switcher.io.export", 2);
            case BOTH -> new PageGroupingData("gt6.multiblock.page_switcher.io.both", 3);
            case NONE -> null;
        };
    }
}
