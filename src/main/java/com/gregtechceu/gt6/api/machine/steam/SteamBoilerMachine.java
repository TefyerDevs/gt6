...
public abstract class SteamBoilerMachine extends SteamWorkableMachine
    ...
    public ModularUI createUI(Player entityPlayer) {
        return new ModularUI(176, 166, this, entityPlayer)
                ...
                .widget(new ProgressWidget(this::getTemperaturePercent, 96, 26, 10, 54)
                        ...
                        .setDynamicHoverTips(pct -> I18n.get("gt6.multiblock.large_boiler.temperature",
    ...
    public List<Component> getDataInfo(PortableScannerBehavior.DisplayMode mode) {
        if (mode == PortableScannerBehavior.DisplayMode.SHOW_ALL ||
            ...
            return Collections.singletonList(Component.translatable("gt6.machine.steam_boiler.heat_amount",
