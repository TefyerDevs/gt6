...
public class MultiblockDisplayText {
    ...
    public static class Builder {
        ...
        private String idlingKey = "gt6.multiblock.idling";
        private String pausedKey = "gt6.multiblock.work_paused";
        private String runningKey = "gt6.multiblock.running";
        ...
        private Builder(List<Component> textList, boolean isStructureFormed,
            ...
            if (!isStructureFormed && showIncompleteStructureWarning) {
                MutableComponent base = Component.translatable("gt6.multiblock.invalid_structure")
                        .withStyle(ChatFormatting.RED);
                Component hover = Component.translatable("gt6.multiblock.invalid_structure.tooltip")
        ...
        public Builder addEnergyUsageLine(IEnergyContainer energyContainer) {
            ...
            if (energyContainer != null && energyContainer.getEnergyCapacity() > 0) {
                ...
                MutableComponent bodyText = Component.translatable("gt6.multiblock.max_energy_per_tick",
                        energyFormatted, voltageName).withStyle(ChatFormatting.GRAY);
                Component hoverText = Component.translatable("gt6.multiblock.max_energy_per_tick_hover")
                        .withStyle(ChatFormatting.GRAY);
        ...
        public Builder addEnergyTierLine(int tier) {
            ...
            MutableComponent bodyText = Component.translatable(
                    "gt6.multiblock.max_recipe_tier",
                    voltageName).withStyle(ChatFormatting.GRAY);
            Component hoverText = Component.translatable("gt6.multiblock.max_recipe_tier_hover")
                    .withStyle(ChatFormatting.GRAY);
        ...
        public Builder addEnergyUsageExactLine(long energyUsage) {
            ...
            if (energyUsage > 0) {
                ...
                textList.add(Component.translatable("gt6.multiblock.energy_consumption",
                        energyFormatted, voltageName).withStyle(ChatFormatting.GRAY));
            }
            return this;
        }
        ...
        public Builder addEnergyProductionLine(long maxVoltage, long recipeEUt) {
            ...
            if (maxVoltage != 0 && maxVoltage >= -recipeEUt) {
                ...
                textList.add(Component.translatable("gt6.multiblock.max_energy_per_tick",
                        energyFormatted, voltageName).withStyle(ChatFormatting.GRAY));
            }
            return this;
        }
        ...
        public Builder addEnergyProductionAmpsLine(long maxVoltage, int amperage) {
            ...
            if (maxVoltage != 0 && amperage != 0) {
                ...
                textList.add(Component.translatable("gt6.multiblock.max_energy_per_tick_amps",
        ...
        public Builder addComputationUsageLine(int maxCWUt) {
            ...
            if (maxCWUt > 0) {
                ...
                textList.add(Component.translatable("gt6.multiblock.computation.max",
        ...
        public Builder addComputationUsageExactLine(int currentCWUt) {
            ...
            if (isActive && currentCWUt > 0) {
                ...
                textList.add(Component.translatable(
                        "gt6.multiblock.computation.usage",
                        computation).withStyle(ChatFormatting.GRAY));
            }
            return this;
        }
        ...
        public Builder addProgressLineOnlyPercent(double progressPercent) {
            ...
            textList.add(Component.translatable("gt6.multiblock.progress_percent", currentProgress));
            return this;
        }
        ...
        public Builder addProgressLine(double currentDuration, double maxDuration, double progressPercent) {
            ...
            textList.add(Component.translatable("gt6.multiblock.progress",
        ...
        public Builder addBatchModeLine(boolean batchEnabled, int batchAmount) {
            if (batchEnabled && batchAmount > 0) {
                textList.add(Component.translatable("gt6.multiblock.batch_enabled", batchAmount));
            }
            return this;
        }
            ...
            if (recipe != null) {
                ...
                for (var item : itemOutputs) {
                    ...
                    if (count < maxDurationSec) {
                        String key = "gt6.multiblock.output_line." + (item.chance < item.maxChance ? "2" : "0");
                        textList.add(Component.translatable(key, stack.getHoverName(), count,
                                FormattingUtil.formatNumber2Places(maxDurationSec / countD)));
                    } else {
                        String key = "gt6.multiblock.output_line." + (item.chance < item.maxChance ? "3" : "1");
                        textList.add(Component.translatable(key, stack.getHoverName(), count,
                ...
                for (var fluid : fluidOutputs) {
                    ...
                    if (amount < maxDurationSec) {
                        String key = "gt6.multiblock.output_line." + (fluid.chance < fluid.maxChance ? "2" : "0");
                        ...
                        String key = "gt6.multiblock.output_line." + (fluid.chance < fluid.maxChance ? "3" : "1");
                        textList.add(Component.translatable(key, stack.getDisplayName(), amount,
        ...
        public Builder addMachineModeLine(GTRecipeType recipeType, boolean hasMultipleModes) {
            ...
            textList.add(Component
                    .translatable("gt6.gui.machinemode",
        ...
        public Builder addLowPowerLine(boolean isLowPower) {
            ...
            if (isLowPower) {
                textList.add(
                        Component.translatable("gt6.multiblock.not_enough_energy").withStyle(ChatFormatting.YELLOW));
            }
            return this;
        }
        ...
        public Builder addLowComputationLine(boolean isLowComputation) {
            if (!isStructureFormed)
                return this;
            if (isLowComputation) {
                textList.add(Component.translatable("gt6.multiblock.computation.not_enough_computation")
        ...
        public Builder addLowDynamoTierLine(boolean isTooLow) {
            if (!isStructureFormed)
                return this;
            if (isTooLow) {
                textList.add(Component.translatable("gt6.multiblock.not_enough_energy_output")
                        .withStyle(ChatFormatting.YELLOW));
            }
            return this;
        }
        ...
        public Builder addMaintenanceProblemLines(byte maintenanceProblems) {
            ...
            if (maintenanceProblems <= 0b111111 && maintenanceProblems > 0) {
                ...
                if ((maintenanceProblems & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.wrench")
                            .withStyle(ChatFormatting.GRAY));
                }

                // Screwdriver
                if (((maintenanceProblems >> 1) & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.screwdriver")
                            .withStyle(ChatFormatting.GRAY));
                }

                // Soft Mallet
                if (((maintenanceProblems >> 2) & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.soft_mallet")
                            .withStyle(ChatFormatting.GRAY));
                }

                // Hammer
                if (((maintenanceProblems >> 3) & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.hard_hammer")
                            .withStyle(ChatFormatting.GRAY));
                }

                // Wire Cutters
                if (((maintenanceProblems >> 4) & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.wire_cutter")
                            .withStyle(ChatFormatting.GRAY));
                }

                // Crowbar
                if (((maintenanceProblems >> 5) & 1) == 0) {
                    textList.add(Component.translatable("gt6.multiblock.universal.problem.crowbar")
                            .withStyle(ChatFormatting.GRAY));
                }
            }
            return this;
        ...
        private void addMaintenanceProblemHeader() {
            textList.add(
                    Component.translatable("gt6.multiblock.universal.has_problems").withStyle(ChatFormatting.YELLOW));
        }
        ...
        public Builder addMufflerObstructedLine(boolean isObstructed) {
            if (!isStructureFormed)
                return this;
            if (isObstructed) {
                textList.add(Component.translatable("gt6.multiblock.universal.muffler_obstructed")
                        .withStyle(ChatFormatting.RED));
                textList.add(Component.translatable("gt6.multiblock.universal.muffler_obstructed.tooltip")
                        .withStyle(ChatFormatting.GRAY));
            }
            return this;
        }
        ...
        public Builder addFuelNeededLine(String fuelName, int previousRecipeDuration) {
            ...
            Component numTicks = Component.literal(FormattingUtil.formatNumbers(previousRecipeDuration))
                    .withStyle(ChatFormatting.AQUA);
            textList.add(Component.translatable(
                    "gt6.multiblock.turbine.fuel_needed",
        ...
        public Builder addCurrentEnergyProductionLine(long euOutput) {
            textList.add(Component.translatable("gt6.multiblock.turbine.energy_per_tick_maxed",
