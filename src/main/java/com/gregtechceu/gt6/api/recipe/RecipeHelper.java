    ...
    public static ActionResult checkConditions(GTRecipe recipe, @NotNull RecipeLogic recipeLogic) {
        ...
        for (RecipeCondition condition : recipe.conditions) {
            if (condition.isOr()) {
                ...
                return ActionResult.fail(Component.translatable("gt6.recipe_logic.condition_fails")
                        .append(": ")
        ...
        for (List<RecipeCondition> conditions : or.values()) {
            ...
            MutableComponent component = Component.translatable("gt6.recipe_logic.condition_fails")
                    .append(": ");
