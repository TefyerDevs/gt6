package com.gregtechceu.gt6.common.block.explosive;

import com.gregtechceu.gt6.common.entity.GTExplosiveEntity;
...
public abstract class GTExplosiveBlock extends Block {
    ...
    public void appendHoverText(ItemStack stack, @Nullable BlockGetter level, List<Component> tooltip,
        ...
        if (explodeOnMine) {
            tooltip.add(Component.translatable("block.gt6.explosive.breaking_tooltip"));
        }
        if (!canRedstoneActivate) {
            tooltip.add(Component.translatable("block.gt6.explosive.lighting_tooltip"));
        }
    }
}
