...
import static com.gregtechceu.gt6.common.data.GTRecipeTypes.MULTIBLOCK;
import static com.gregtechceu.gt6.common.data.GTRecipeTypes.register;
...
public class GCYMRecipeTypes {
    ...
    public final static GTRecipeType ALLOY_BLAST_RECIPES = register("alloy_blast_smelter", MULTIBLOCK)
            ...
            .addDataInfo(data -> {
                ...
                return LocalizationUtils.format("gt6.recipe.temperature", FormattingUtil.formatNumbers(temp));
            })
            .addDataInfo(data -> {
                int temp = data.getInt("ebf_temp");
