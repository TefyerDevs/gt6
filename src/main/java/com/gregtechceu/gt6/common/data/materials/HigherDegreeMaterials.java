...
public class HigherDegreeMaterials {
    ...
    public static void register() {
        Electrotine = new Material.Builder(Gregtech.id("electrotine"))
                .dust().ore(5, 1, true)
        ...
        EnderEye = new Material.Builder(Gregtech.id("ender_eye"))
                .gem(1)
        ...
        Diatomite = new Material.Builder(Gregtech.id("diatomite"))
                .dust(1).ore()
                .color(0xfffafa)
                .components(Flint, 8, Hematite, 1, Sapphire, 1)
                .buildAndRegister();

        RedSteel = new Material.Builder(Gregtech.id("red_steel"))
                .ingot(3).fluid()
        ...
        BlueSteel = new Material.Builder(Gregtech.id("blue_steel"))
                .ingot(3).fluid()
        ...
        Basalt = new Material.Builder(Gregtech.id("basalt"))
                .dust(1)
        ...
        GraniticMineralSand = new Material.Builder(Gregtech.id("granitic_mineral_sand"))
                .dust(1).ore()
        ...
        Redrock = new Material.Builder(Gregtech.id("redrock"))
                .dust(1)
        ...
        GarnetSand = new Material.Builder(Gregtech.id("garnet_sand"))
                .dust(1).ore()
        ...
        HSSG = new Material.Builder(Gregtech.id("hssg"))
                .ingot(3).fluid()
        ...
        RedAlloy = new Material.Builder(Gregtech.id("red_alloy"))
                .ingot(0)
        ...
        BasalticMineralSand = new Material.Builder(Gregtech.id("basaltic_mineral_sand"))
                .dust(1).ore()
        ...
        HSSE = new Material.Builder(Gregtech.id("hsse"))
                .ingot(4).fluid()
        ...
        HSSS = new Material.Builder(Gregtech.id("hsss"))
                .ingot(4).fluid()
        ...
        IridiumMetalResidue = new Material.Builder(Gregtech.id("iridium_metal_residue"))
                .dust()
        ...
        Granite = new Material.Builder(Gregtech.id("granite"))
                .dust()
        ...
        Brick = new Material.Builder(Gregtech.id("brick"))
                .dust()
        ...
        Fireclay = new Material.Builder(Gregtech.id("fireclay"))
                .dust()
        ...
        Diorite = new Material.Builder(Gregtech.id("diorite"))
                .dust()
        ...
        BlueAlloy = new Material.Builder(Gregtech.id("blue_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1400))
        ...
        RadAway = new Material.Builder(Gregtech.id("rad_away"))
                .dust()
        ...
        Blackstone = new Material.Builder(Gregtech.id("blackstone"))
                .dust()
