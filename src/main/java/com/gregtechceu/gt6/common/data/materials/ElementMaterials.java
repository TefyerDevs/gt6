...
import com.gregtechceu.gt6.common.data.GTElements;
...
public class ElementMaterials {
    ...
    public static void register() {
        Actinium = new Material.Builder(Gregtech.id("actinium"))
                .color(0xC3D1FF).secondaryColor(0x397090).iconSet(METALLIC)
                .element(GTElements.Ac)
                .buildAndRegister();

        Aluminium = new Material.Builder(Gregtech.id("aluminium"))
                .ingot()
        ...
        Americium = new Material.Builder(Gregtech.id("americium"))
                .ingot(3)
        ...
        Antimony = new Material.Builder(Gregtech.id("antimony"))
                .ingot()
        ...
        Argon = new Material.Builder(Gregtech.id("argon"))
                .gas().plasma()
                .color(0x00FF00)
                .element(GTElements.Ar)
                .buildAndRegister();

        Arsenic = new Material.Builder(Gregtech.id("arsenic"))
                .dust()
        ...
        Astatine = new Material.Builder(Gregtech.id("astatine"))
                .color(0x65204f).secondaryColor(0x17212b)
                .element(GTElements.At)
                .buildAndRegister();

        Barium = new Material.Builder(Gregtech.id("barium"))
                .dust()
                .color(0xede192).secondaryColor(0xa7ad4d).iconSet(METALLIC)
                .element(GTElements.Ba)
                .buildAndRegister();

        Berkelium = new Material.Builder(Gregtech.id("berkelium"))
                .color(0x645A88).iconSet(RADIOACTIVE)
                .element(GTElements.Bk)
                .buildAndRegister();

        Beryllium = new Material.Builder(Gregtech.id("beryllium"))
                .ingot()
        ...
        Bismuth = new Material.Builder(Gregtech.id("bismuth"))
                .ingot(1)
        ...
        Cadmium = new Material.Builder(Gregtech.id("cadmium"))
                .dust()
        ...
        Cerium = new Material.Builder(Gregtech.id("cerium"))
                .dust()
        ...
        Chlorine = new Material.Builder(Gregtech.id("chlorine"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .element(GTElements.Cl)
                // TODO hazard
                .buildAndRegister();

        Chromium = new Material.Builder(Gregtech.id("chromium"))
                .ingot(3)
        ...
        Cobalt = new Material.Builder(Gregtech.id("cobalt"))
                .ingot()
        ...
        Copernicium = new Material.Builder(Gregtech.id("copernicium"))
                .color(0x565c5d).secondaryColor(0xffd34b).iconSet(RADIOACTIVE)
                .element(GTElements.Cn)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Copper = new Material.Builder(Gregtech.id("copper"))
                .ingot(1)
        ...
        Curium = new Material.Builder(Gregtech.id("curium"))
                .color(0x7B544E).iconSet(RADIOACTIVE)
                .element(GTElements.Cm)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Darmstadtium = new Material.Builder(Gregtech.id("darmstadtium"))
                .ingot().fluid()
        ...
        Deuterium = new Material.Builder(Gregtech.id("deuterium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .element(GTElements.D)
                .buildAndRegister();

        Dubnium = new Material.Builder(Gregtech.id("dubnium"))
                .color(0xc7ddde).secondaryColor(0x00f3ff).iconSet(RADIOACTIVE)
                .element(GTElements.Db)
                .buildAndRegister();

        Dysprosium = new Material.Builder(Gregtech.id("dysprosium"))
                .color(0x6a664b).secondaryColor(0x423307)
                .iconSet(METALLIC)
                .element(GTElements.Dy)
                .buildAndRegister();

        Einsteinium = new Material.Builder(Gregtech.id("einsteinium"))
                .color(0xCE9F00).iconSet(RADIOACTIVE)
                .element(GTElements.Es)
                .buildAndRegister();

        Erbium = new Material.Builder(Gregtech.id("erbium"))
                .color(0xeccbdb).secondaryColor(0x5d625a)
                .iconSet(METALLIC)
                .element(GTElements.Er)
                .buildAndRegister();

        Europium = new Material.Builder(Gregtech.id("europium"))
                .ingot()
        ...
        Germanium = new Material.Builder(Gregtech.id("germanium"))
                .color(0x4a4a4a).secondaryColor(0x2d2612).iconSet(SHINY)
                .element(GTElements.Ge)
                .buildAndRegister();

        Gold = new Material.Builder(Gregtech.id("gold"))
                .ingot()
        ...
        Hafnium = new Material.Builder(Gregtech.id("hafnium"))
                .color(0x99999A).secondaryColor(0x2b4a3a).iconSet(SHINY)
                .element(GTElements.Hf)
                .buildAndRegister();

        Hassium = new Material.Builder(Gregtech.id("hassium"))
                .color(0x738786).secondaryColor(0x62ffd5)
                .iconSet(RADIOACTIVE)
                .element(GTElements.Hs)
                .buildAndRegister();

        Holmium = new Material.Builder(Gregtech.id("holmium"))
                .color(0xf6fc9c).secondaryColor(0xa3a3a3)
                .iconSet(METALLIC)
                .element(GTElements.Ho)
                .buildAndRegister();

        Hydrogen = new Material.Builder(Gregtech.id("hydrogen"))
                .gas()
                .color(0x0000B5)
                .element(GTElements.H)
                .buildAndRegister();

        Helium = new Material.Builder(Gregtech.id("helium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .plasma()
                .liquid(new FluidBuilder()
                        ...
                        .color(0xFCFF90)
                        .name("liquid_helium")
                        .translation("gt6.fluid.liquid_generic"))
                .element(GTElements.He)
                .buildAndRegister();
        Helium.getProperty(PropertyKey.FLUID).setPrimaryKey(FluidStorageKeys.GAS);

        Helium3 = new Material.Builder(Gregtech.id("helium_3"))
                .gas(new FluidBuilder()
                        .customStill()
                        .translation("gt6.fluid.generic"))
                .element(GTElements.He3)
                .buildAndRegister();

        Indium = new Material.Builder(Gregtech.id("indium"))
                .ingot()
        ...
        Iodine = new Material.Builder(Gregtech.id("iodine"))
                .dust()
                .color(0x3e4467).secondaryColor(0x021e40).iconSet(SHINY)
                .element(GTElements.I)
                .buildAndRegister();

        Iridium = new Material.Builder(Gregtech.id("iridium"))
                .ingot(3)
        ...
        Iron = new Material.Builder(Gregtech.id("iron"))
                .ingot()
        ...
        Krypton = new Material.Builder(Gregtech.id("krypton"))
                .gas(new FluidBuilder()
                        .customStill()
                        .translation("gt6.fluid.generic"))
                .color(0x80FF80)
        ...
        Lanthanum = new Material.Builder(Gregtech.id("lanthanum"))
                .dust()
        ...
        Lawrencium = new Material.Builder(Gregtech.id("lawrencium"))
                .color(0x5D7575)
                .iconSet(RADIOACTIVE)
                .element(GTElements.Lr)
                .buildAndRegister();

        Lead = new Material.Builder(Gregtech.id("lead"))
                .ingot(1)
        ...
        Lithium = new Material.Builder(Gregtech.id("lithium"))
                .dust()
        ...
        Livermorium = new Material.Builder(Gregtech.id("livermorium"))
                .color(0x939393).secondaryColor(0xff5e5e).iconSet(RADIOACTIVE)
                .element(GTElements.Lv)
                .buildAndRegister();

        Lutetium = new Material.Builder(Gregtech.id("lutetium"))
                .dust()
        ...
        Magnesium = new Material.Builder(Gregtech.id("magnesium"))
                .dust()
        ...
        Mendelevium = new Material.Builder(Gregtech.id("mendelevium"))
                .color(0x1D4ACF).iconSet(RADIOACTIVE)
                .element(GTElements.Md)
                .buildAndRegister();

        Manganese = new Material.Builder(Gregtech.id("manganese"))
                .ingot()
        ...
        Meitnerium = new Material.Builder(Gregtech.id("meitnerium"))
                .color(0x4f3c82).secondaryColor(0x6e90ff).iconSet(RADIOACTIVE)
                .element(GTElements.Mt)
                .buildAndRegister();

        Mercury = new Material.Builder(Gregtech.id("mercury"))
                .fluid()
        ...
        Molybdenum = new Material.Builder(Gregtech.id("molybdenum"))
                .ingot()
        ...
        Moscovium = new Material.Builder(Gregtech.id("moscovium"))
                .color(0x2a1b40).secondaryColor(0xbd91ff).iconSet(RADIOACTIVE)
                .element(GTElements.Mc)
                .buildAndRegister();

        Neodymium = new Material.Builder(Gregtech.id("neodymium"))
                .ingot().fluid().ore()
        ...
        Neon = new Material.Builder(Gregtech.id("neon"))
                .gas()
                .color(0xFAB4B4)
                .element(GTElements.Ne)
                .buildAndRegister();

        Neptunium = new Material.Builder(Gregtech.id("neptunium"))
                .color(0x284D7B).iconSet(RADIOACTIVE)
                .element(GTElements.Np)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Nickel = new Material.Builder(Gregtech.id("nickel"))
                .ingot()
        ...
        Nihonium = new Material.Builder(Gregtech.id("nihonium"))
                .color(0x323957).secondaryColor(0xbfabff).iconSet(RADIOACTIVE)
                .element(GTElements.Nh)
                .buildAndRegister();

        Niobium = new Material.Builder(Gregtech.id("niobium"))
                .ingot().fluid()
        ...
        Nitrogen = new Material.Builder(Gregtech.id("nitrogen"))
                .gas().plasma()
                .color(0x00BFC1)
                .element(GTElements.N)
                .buildAndRegister();

        Nobelium = new Material.Builder(Gregtech.id("nobelium"))
                .color(0x3e4758).secondaryColor(0x43deff)
                .iconSet(RADIOACTIVE)
                .element(GTElements.No)
                .buildAndRegister();

        Oganesson = new Material.Builder(Gregtech.id("oganesson"))
                .color(0x443936).secondaryColor(0xff1dbd).iconSet(RADIOACTIVE)
                .element(GTElements.Og)
                .buildAndRegister();

        Osmium = new Material.Builder(Gregtech.id("osmium"))
                .ingot(4)
        ...
        Oxygen = new Material.Builder(Gregtech.id("oxygen"))
                .gas()
                .liquid(new FluidBuilder()
                        .temperature(85)
                        .color(0x6688DD)
        ...
        Palladium = new Material.Builder(Gregtech.id("palladium"))
                .ingot().fluid().ore()
        ...
        Phosphorus = new Material.Builder(Gregtech.id("phosphorus"))
                .dust()
                .color(0x77332c).secondaryColor(0x220202)
                .element(GTElements.P)
                .buildAndRegister();

        Polonium = new Material.Builder(Gregtech.id("polonium"))
        ...
        Platinum = new Material.Builder(Gregtech.id("platinum"))
                .ingot()
        ...
        Plutonium239 = new Material.Builder(Gregtech.id("plutonium"))
                .ingot(3)
        ...
        Plutonium241 = new Material.Builder(Gregtech.id("plutonium_241"))
                .ingot(3)
                .liquid(new FluidBuilder().temperature(913))
        ...
        Potassium = new Material.Builder(Gregtech.id("potassium"))
                .dust(1)
        ...
        Praseodymium = new Material.Builder(Gregtech.id("praseodymium"))
                .color(0x718060).secondaryColor(0x3f3447).iconSet(METALLIC)
                .element(GTElements.Pr)
                .buildAndRegister();

        Promethium = new Material.Builder(Gregtech.id("promethium"))
        ...
        Protactinium = new Material.Builder(Gregtech.id("protactinium"))
                .color(0xA78B6D).iconSet(RADIOACTIVE)
                .element(GTElements.Pa)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Radon = new Material.Builder(Gregtech.id("radon"))
                .gas()
                .color(0xFF39FF)
        ...
        Roentgenium = new Material.Builder(Gregtech.id("roentgenium"))
                .color(0x388c48).secondaryColor(0x198a92).iconSet(RADIOACTIVE)
                .element(GTElements.Rg)
                .buildAndRegister();

        Rubidium = new Material.Builder(Gregtech.id("rubidium"))
                .color(0xde0f0f).secondaryColor(0x3a1f1f).iconSet(SHINY)
                .element(GTElements.Rb)
                .buildAndRegister();

        Ruthenium = new Material.Builder(Gregtech.id("ruthenium"))
                .ingot().fluid()
        ...
        Rutherfordium = new Material.Builder(Gregtech.id("rutherfordium"))
                .color(0x6b6157).secondaryColor(0xFFF6A1).iconSet(RADIOACTIVE)
                .element(GTElements.Rf)
                .buildAndRegister();

        Samarium = new Material.Builder(Gregtech.id("samarium"))
                .ingot()
        ...
        Silver = new Material.Builder(Gregtech.id("silver"))
                .ingot()
        ...
        Tantalum = new Material.Builder(Gregtech.id("tantalum"))
                .ingot()
        ...
        Titanium = new Material.Builder(Gregtech.id("titanium")) // todo Ore? Look at EBF recipe here if we do Ti ores
                .ingot(3).fluid()
        ...
        Tritium = new Material.Builder(Gregtech.id("tritium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
        ...
        Tungsten = new Material.Builder(Gregtech.id("tungsten"))
                .ingot(3)
        ...
        Uranium238 = new Material.Builder(Gregtech.id("uranium"))
                .ingot(3)
        ...
        Uranium235 = new Material.Builder(Gregtech.id("uranium_235"))
                .ingot(3)
                .liquid(new FluidBuilder().temperature(1405))
        ...
        Vanadium = new Material.Builder(Gregtech.id("vanadium"))
                .ingot().fluid()
        ...
        Xenon = new Material.Builder(Gregtech.id("xenon"))
                .gas()
                .color(0x00FFFF)
                .element(GTElements.Xe)
                .buildAndRegister();

        Ytterbium = new Material.Builder(Gregtech.id("ytterbium"))
                .color(0xA7A7A7).iconSet(METALLIC)
                .element(GTElements.Yb)
                .buildAndRegister();

        Yttrium = new Material.Builder(Gregtech.id("yttrium"))
                .ingot().fluid()
        ...
        Zinc = new Material.Builder(Gregtech.id("zinc"))
                .ingot(1)
        ...
        Zirconium = new Material.Builder(Gregtech.id("zirconium"))
                .color(0xb99b7e).secondaryColor(0x271813).iconSet(METALLIC)
                .element(GTElements.Zr)
                .buildAndRegister();

        Naquadah = new Material.Builder(Gregtech.id("naquadah"))
                .ingot(4)
        ...
        NaquadahEnriched = new Material.Builder(Gregtech.id("enriched_naquadah"))
                .ingot(4)
                .liquid(new FluidBuilder().customStill())
        ...
        Naquadria = new Material.Builder(Gregtech.id("naquadria"))
                .ingot(3)
                .liquid(new FluidBuilder().customStill())
        ...
        Neutronium = new Material.Builder(Gregtech.id("neutronium"))
                .ingot(6)
        ...
        Tritanium = new Material.Builder(Gregtech.id("tritanium"))
                .ingot(6)
        ...
        Duranium = new Material.Builder(Gregtech.id("duranium"))
                .ingot(5)
        ...
        Trinium = new Material.Builder(Gregtech.id("trinium"))
                .ingot(7).fluid()
