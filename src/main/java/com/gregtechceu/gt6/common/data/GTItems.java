...
import com.gregtechceu.gt6.api.data.chemical.material.stack.ItemMaterialInfo;
...
import com.gregtechceu.gt6.api.item.TagPrefixItem;
import com.gregtechceu.gt6.api.item.armor.ArmorComponentItem;
import com.gregtechceu.gt6.api.item.component.*;
import com.gregtechceu.gt6.api.item.tool.MaterialToolTier;
import com.gregtechceu.gt6.common.data.materials.GTFoods;
import com.gregtechceu.gt6.common.entity.GTBoat;
import com.gregtechceu.gt6.common.item.*;
import com.gregtechceu.gt6.common.item.armor.*;
import com.gregtechceu.gt6.common.item.modules.ImageModuleBehaviour;
import com.gregtechceu.gt6.common.item.modules.TextModuleBehaviour;
import com.gregtechceu.gt6.common.item.tool.behavior.LighterBehavior;
import com.gregtechceu.gt6.common.item.tool.behavior.MetaMachineConfigCopyBehaviour;
...
import com.gregtechceu.gt6.utils.memoization.GTMemoizer;
...
import static com.gregtechceu.gt6.common.data.GTCreativeModeTabs.*;
...
public class GTItems {
        ...
        return new ICustomDescriptionId() {
            ...
            public Component getItemName(ItemStack stack) {
                Component prefix = FluidUtil.getFluidContained(stack).map(FluidStack::getDisplayName)
                        .orElse(Component.translatable("gt6.fluid.empty"));
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_LV = REGISTRATE.item("lv_electric_pump", ComponentItem::create)
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.electric.pump.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate",
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_UV = REGISTRATE.item("uv_electric_pump", ComponentItem::create)
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.electric.pump.tooltip"));
                lines.add(
                        Component.translatable("gt6.universal.tooltip.fluid_transfer_rate",
    ...
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_LV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 / 20));
            })))
    ...
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_MV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 4 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_HV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 16 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_EV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 64 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_IV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 64 * 4 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_LuV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 64 * 16 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_ZPM = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 64 * 64 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.fluid.regulator.tooltip"));
                lines.add(
                        Component.translatable("gt6.universal.tooltip.fluid_transfer_rate", 1280 * 64 * 64 * 4 / 20));
            })))
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    ...
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_LV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate", 8));
            })))
    ...
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_MV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate", 32));
            })))
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_HV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate", 64));
            })))
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_EV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate_stacks", 3));
            })))
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_IV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate_stacks", 8));
            })))
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_LuV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.conveyor.module.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate_stacks", 16));
            })))
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    ...
    public static ItemEntry<ComponentItem> ROBOT_ARM_LV = REGISTRATE.item("lv_robot_arm", ComponentItem::create)
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.gt6.robot.arm.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.item_transfer_rate", 8));
            })))
    ...
    public static ItemEntry<ComponentItem> COVER_INFINITE_WATER = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("gt6.universal.tooltip.produces_fluid", 16_000 / 20));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL = REGISTRATE.item("solar_panel", ComponentItem::create)
            .lang("Solar Panel").onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", 1, GTValues.VNF[GTValues.ULV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_ULV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.ULV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_LV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.LV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_MV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.MV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_HV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.HV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_EV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.EV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_IV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.IV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_LuV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.LuV],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_ZPM = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.ZPM],
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_UV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gt6.solar_panel.tooltip"));
                lines.add(Component.translatable("gt6.universal.tooltip.voltage_out", GTValues.V[GTValues.UV],
    ...
    public static ItemEntry<ArmorComponentItem> FACE_MASK = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(tooltips -> {
                tooltips.add(Component.translatable("gt6.hazard_trigger.protection.description"));
                tooltips.add(Component.translatable("gt6.hazard_trigger.inhalation"));
            })))
            .register();
    public static ItemEntry<ArmorComponentItem> RUBBER_GLOVES = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(tooltips -> {
                tooltips.add(Component.translatable("gt6.hazard_trigger.protection.description"));
                tooltips.add(Component.translatable("gt6.hazard_trigger.skin_contact"));
            })))
            .register();
