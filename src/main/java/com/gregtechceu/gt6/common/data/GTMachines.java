...
import com.gregtechceu.gt6.common.data.machines.*;
import com.gregtechceu.gt6.common.data.models.GTModels;
import com.gregtechceu.gt6.common.machine.electric.*;
import com.gregtechceu.gt6.common.machine.multiblock.part.*;
import com.gregtechceu.gt6.common.machine.multiblock.part.monitor.MonitorPartMachine;
import com.gregtechceu.gt6.common.machine.steam.SteamLiquidBoilerMachine;
import com.gregtechceu.gt6.common.machine.steam.SteamMinerMachine;
import com.gregtechceu.gt6.common.machine.steam.SteamSolarBoiler;
import com.gregtechceu.gt6.common.machine.steam.SteamSolidBoilerMachine;
import com.gregtechceu.gt6.common.machine.storage.*;
import com.gregtechceu.gt6.common.pipelike.fluidpipe.longdistance.LDFluidEndpointMachine;
import com.gregtechceu.gt6.common.pipelike.item.longdistance.LDItemEndpointMachine;
...
import static com.gregtechceu.gt6.common.data.GTCreativeModeTabs.MACHINE;
import static com.gregtechceu.gt6.common.data.GTRecipeTypes.DUMMY_RECIPES;
import static com.gregtechceu.gt6.common.data.GTRecipeTypes.STEAM_BOILER_RECIPES;
import static com.gregtechceu.gt6.common.data.machines.GTMachineUtils.*;
import static com.gregtechceu.gt6.common.data.machines.GTMachineUtils.ALL_TIERS;
...
public class GTMachines {
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_MINER = registerSteamMachines(
            ...
            (isHP, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.uses_per_tick_steam", isHP ? 32 : 16)
                            .append(ChatFormatting.GRAY + ", ")
                            .append(Component.translatable("gt6.machine.miner.per_block",
                                    isHP ? 240 / 20 : 280 / 20)))
                    .tooltipBuilder((item, tooltip) -> {
                        int maxArea = IMiner.getWorkingArea(isHP ? 6 : 4);
                        tooltip.add(Component.translatable("gt6.universal.tooltip.working_area", maxArea, maxArea));
                    })
    ...
    public static final MachineDefinition[] HULL = GTMachineUtils.registerTieredMachines("machine_hull",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.hull.tooltip"))
                    .register(),
            ALL_TIERS);
    ...
    public static final MachineDefinition LONG_DIST_ITEM_ENDPOINT = REGISTRATE
            ...
            .tooltipBuilder((stack, tooltip) -> {
                if (ConfigHolder.INSTANCE.machines.ldItemPipeMinDistance > 0) {
                    tooltip.add(Component.translatable("gt6.machine.endpoint.tooltip.min_length",
    ...
    public static final MachineDefinition[] PUMP = registerTieredMachines("pump", PumpMachine::new,
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.pump.tooltip"),
                            ...
                            Component.translatable("gt6.universal.tooltip.working_area",
    ...
    public static final MachineDefinition[] FISHER = registerTieredMachines("fisher", FisherMachine::new,
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.fisher.tooltip"),
                            Component.translatable("gt6.machine.fisher.speed", FisherMachine.calcMaxProgress(tier)),
                            Component.translatable("gt6.machine.fisher.requirement", FisherMachine.WATER_CHECK_SIZE,
    ...
    public static final MachineDefinition[] MINER = registerTieredMachines("miner",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltipBuilder((stack, tooltip) -> {
                        ...
                        tooltip.add(Component.translatable("gt6.machine.miner.tooltip", maxArea, maxArea));
                        tooltip.add(Component.translatable("gt6.universal.tooltip.uses_per_tick", energyPerTick)
                                .append(Component.literal(", ").withStyle(ChatFormatting.GRAY))
                                .append(Component.translatable("gt6.machine.miner.per_block", tickSpeed / 20)));
                        tooltip.add(Component.translatable("gt6.universal.tooltip.voltage_in",
                                FormattingUtil.formatNumbers(GTValues.V[tier]),
                                GTValues.VNF[tier]));
                        tooltip.add(Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                FormattingUtil.formatNumbers(GTValues.V[tier] * 64L)));

                        tooltip.add(
                                Component.translatable("gt6.universal.tooltip.working_area_max", maxArea, maxArea));
                    })
                    .register(),
            LV, MV, HV);
    ...
    public static final MachineDefinition[] WORLD_ACCELERATOR = registerTieredMachines("world_accelerator",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltipBuilder((stack, tooltip) -> {
                        ...
                        tooltip.add(Component.translatable("gt6.machine.world_accelerator.working_area"));
                        tooltip.add(Component.translatable("gt6.machine.world_accelerator.working_area_tile"));
                        tooltip.add(Component.translatable("gt6.machine.world_accelerator.working_area_random",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(
                            ...
                            Component.translatable(
                                    "gt6.universal.tooltip.item_storage_capacity",
                                    BufferMachine.getInventorySize(tier)),
                            Component.translatable(
                                    "gt6.universal.tooltip.fluid_storage_capacity_mult",
    ...
    public static final BiConsumer<ItemStack, List<Component>> CREATIVE_TOOLTIPS = (stack, list) -> list.add(
            Component.translatable("gt6.creative_tooltip.1")
                    .append(Component.translatable("gt6.creative_tooltip.2")
                            .withStyle(TooltipHelper.RAINBOW_HSL_SLOW))
                    .append(Component.translatable("gt6.creative_tooltip.3")));
    ...
    public static final MachineDefinition CREATIVE_FLUID = REGISTRATE
            ...
            .tooltipBuilder((stack, list) -> {
                ...
                if (stack.hasTag()) {
                    ...
                    list.add(1, Component.translatable("gt6.universal.tooltip.fluid_stored", f.getDisplayName(),
    ...
    public static final MachineDefinition CREATIVE_ITEM = REGISTRATE
            ...
            .tooltipBuilder((stack, list) -> {
                ...
                if (stack.hasTag()) {
                    ...
                    list.add(1, Component.translatable("gt6.universal.tooltip.item_stored", i.getHoverName(),
                            FormattingUtil.formatNumbers(perCycle)));
                }
            })
            .model(createBasicMachineModel(GTCEu.id("block/machine/template/quantum/creative_container"))
    ...
    public static final MachineDefinition[] ITEM_IMPORT_BUS = registerTieredMachines("input_bus",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.item_bus.import.tooltip"),
    ...
    public static final MachineDefinition[] ITEM_EXPORT_BUS = registerTieredMachines("output_bus",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.item_bus.export.tooltip"),
                            Component.translatable("gt6.universal.tooltip.item_storage_capacity",
                                    (1 + Math.min(9, tier)) * (1 + Math.min(9, tier))))
                    .allowCoverOnFront(true)
                    .register(),
    ...
    public static final MachineDefinition[] ENERGY_INPUT_HATCH = registerTieredMachines("energy_input_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_in",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_in", 2),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
                                            .formatNumbers(EnergyHatchPartMachine.getHatchEnergyCapacity(tier, 2))),
                            Component.translatable("gt6.machine.energy_hatch.input.tooltip"))
    ...
    public static final MachineDefinition[] ENERGY_OUTPUT_HATCH = registerTieredMachines("energy_output_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_out",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_out", 2),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
                                            .formatNumbers(EnergyHatchPartMachine.getHatchEnergyCapacity(tier, 2))),
                            Component.translatable("gt6.machine.energy_hatch.output.tooltip"))
    ...
    public static final MachineDefinition[] ENERGY_INPUT_HATCH_4A = registerTieredMachines("energy_input_hatch_4a",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_in",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_in", 4),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
    ...
    public static final MachineDefinition[] ENERGY_OUTPUT_HATCH_4A = registerTieredMachines("energy_output_hatch_4a",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_out",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_out", 4),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
                                            .formatNumbers(EnergyHatchPartMachine.getHatchEnergyCapacity(tier, 4))),
    ...
    public static final MachineDefinition[] ENERGY_INPUT_HATCH_16A = registerTieredMachines("energy_input_hatch_16a",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_in",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_in", 16),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
    ...
    public static final MachineDefinition[] ENERGY_OUTPUT_HATCH_16A = registerTieredMachines("energy_output_hatch_16a",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_out",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_out", 16),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
                                            .formatNumbers(EnergyHatchPartMachine.getHatchEnergyCapacity(tier, 16))),
                            Component.translatable("gt6.machine.energy_hatch.output_hi_amp.tooltip"))
    ...
    public static final MachineDefinition[] SUBSTATION_ENERGY_INPUT_HATCH = registerTieredMachines(
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_in",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_in", 64),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
    ...
    public static final MachineDefinition[] SUBSTATION_ENERGY_OUTPUT_HATCH = registerTieredMachines(
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.universal.tooltip.voltage_out",
                            FormattingUtil.formatNumbers(V[tier]), VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_out", 64),
                            Component.translatable("gt6.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil
                                            .formatNumbers(EnergyHatchPartMachine.getHatchEnergyCapacity(tier, 64))),
    ...
    public static final MachineDefinition[] MUFFLER_HATCH = registerTieredMachines("muffler_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(LangHandler.getFromMultiLang("gt6.machine.muffler_hatch.tooltip", 0),
                            Component.translatable("gt6.muffler.recovery_tooltip", Math.max(1, tier * 10)),
                            Component.translatable("gt6.part_sharing.enabled"),
                            LangHandler.getFromMultiLang("gt6.machine.muffler_hatch.tooltip", 1)
    ...
    public static final MachineDefinition STEAM_IMPORT_BUS = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.item_bus.import.tooltip"),
                    Component.translatable("gt6.machine.steam_bus.tooltip"),
                    Component.translatable("gt6.universal.tooltip.item_storage_capacity", 4))
            .allowCoverOnFront(true)
            .register();
    ...
    public static final MachineDefinition STEAM_HATCH = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.universal.tooltip.fluid_storage_capacity",
                    SteamHatchPartMachine.INITIAL_TANK_CAPACITY),
                    Component.translatable("gt6.machine.steam.steam_hatch.tooltip"))
            .allowCoverOnFront(true)
            .register();
    ...
    public static final MachineDefinition CLEANING_MAINTENANCE_HATCH = REGISTRATE
            ...
            .abilities(PartAbility.MAINTENANCE)
            .tooltips(Component.translatable("gt6.part_sharing.disabled"),
                    Component.translatable("gt6.machine.maintenance_hatch_cleanroom_auto.tooltip.0"),
                    Component.translatable("gt6.machine.maintenance_hatch_cleanroom_auto.tooltip.1"))
    ...
    public static final MachineDefinition[] FLUID_PASSTHROUGH_HATCH = registerTieredMachines("fluid_passthrough_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.universal.tooltip.fluid_storage_capacity_mult", tier + 1,
    ...
    public static final MachineDefinition[] DUAL_IMPORT_HATCH = registerTieredMachines(
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.machine.dual_hatch.import.tooltip"),
                            Component.translatable(
                                    "gt6.universal.tooltip.item_storage_capacity",
    ...
    public static final MachineDefinition[] DUAL_EXPORT_HATCH = registerTieredMachines(
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.machine.dual_hatch.export.tooltip"),
                            Component.translatable(
                                    "gt6.universal.tooltip.item_storage_capacity",
                                    (int) Math.pow((tier - 4), 2)),
                            Component.translatable(
    ...
    public static final MachineDefinition[] DIODE = registerTieredMachines("diode",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.diode.tooltip_general"),
                            Component.translatable("gt6.machine.diode.tooltip_starts_at"),
                            Component.translatable("gt6.universal.tooltip.voltage_in_out",
                                    FormattingUtil.formatNumbers(GTValues.V[tier]),
                                    GTValues.VNF[tier]),
                            Component.translatable("gt6.universal.tooltip.amperage_in_out_till",
