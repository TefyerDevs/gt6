...
import com.gregtechceu.gt6.common.item.armor.GTArmorItem;
import com.gregtechceu.gt6.common.item.armor.GTDyeableArmorItem;
...
import static com.gregtechceu.gt6.common.data.GTCreativeModeTabs.MATERIAL_ITEM;
import static com.gregtechceu.gt6.common.data.GTCreativeModeTabs.TOOL;
...
public class GTMaterialItems {
    ...
    public static final Table<Material, GTToolType, ItemProviderEntry<IGTTool>> TOOL_ITEMS = ArrayTable.create(
            GTAPI.materialManager.getRegisteredMaterials().stream()
