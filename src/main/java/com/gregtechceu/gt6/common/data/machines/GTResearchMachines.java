...
import com.gregtechceu.gt6.common.data.GTRecipeTypes;
import com.gregtechceu.gt6.common.machine.multiblock.electric.research.DataBankMachine;
import com.gregtechceu.gt6.common.machine.multiblock.electric.research.HPCAMachine;
import com.gregtechceu.gt6.common.machine.multiblock.electric.research.NetworkSwitchMachine;
import com.gregtechceu.gt6.common.machine.multiblock.electric.research.ResearchStationMachine;
import com.gregtechceu.gt6.common.machine.multiblock.part.DataAccessHatchMachine;
import com.gregtechceu.gt6.common.machine.multiblock.part.ObjectHolderMachine;
import com.gregtechceu.gt6.common.machine.multiblock.part.OpticalComputationHatchMachine;
import com.gregtechceu.gt6.common.machine.multiblock.part.OpticalDataHatchMachine;
import com.gregtechceu.gt6.common.machine.multiblock.part.hpca.*;
...
import static com.gregtechceu.gt6.common.data.GTMachines.CREATIVE_TOOLTIPS;
...
public class GTResearchMachines {
    ...
    public static final MultiblockMachineDefinition RESEARCH_STATION = REGISTRATE
            ...
            .tooltips(LangHandler.getMultiLang("gt6.machine.research_station.tooltip"))
    ...
    public static final MachineDefinition DATA_BANK = REGISTRATE.multiblock("data_bank", DataBankMachine::new)
            ...
            .tooltips(Component.translatable("gt6.machine.data_bank.tooltip.0"),
                    Component.translatable("gt6.machine.data_bank.tooltip.1"),
                    Component.translatable("gt6.machine.data_bank.tooltip.2"),
                    Component.translatable("gt6.machine.data_bank.tooltip.3",
                            FormattingUtil.formatNumbers(DataBankMachine.EUT_PER_HATCH)),
                    Component.translatable("gt6.machine.data_bank.tooltip.4",
    ...
    public static final MachineDefinition NETWORK_SWITCH = REGISTRATE
            ...
            .appearanceBlock(COMPUTER_CASING)
            .recipeType(GTRecipeTypes.DUMMY_RECIPES)
            .tooltips(Component.translatable("gt6.machine.network_switch.tooltip.0"),
                    Component.translatable("gt6.machine.network_switch.tooltip.1"),
                    Component.translatable("gt6.machine.network_switch.tooltip.2"),
                    Component.translatable("gt6.machine.network_switch.tooltip.3",
    ...
    public static final MachineDefinition HIGH_PERFORMANCE_COMPUTING_ARRAY = REGISTRATE
            ...
            .appearanceBlock(COMPUTER_CASING)
            .recipeType(GTRecipeTypes.DUMMY_RECIPES)
            .tooltips(LangHandler.getMultiLang("gt6.machine.high_performance_computation_array.tooltip"))
            .pattern(definition -> FactoryBlockPattern.start()
    ...
    public static final MachineDefinition BASIC_DATA_ACCESS_HATCH = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.data_access_hatch.tooltip.0"),
                    Component.translatable("gt6.machine.data_access_hatch.tooltip.1", 4),
    ...
    public static final MachineDefinition DATA_ACCESS_HATCH = REGISTRATE
            ...
            .abilities(PartAbility.DATA_ACCESS)
            .tooltips(Component.translatable("gt6.machine.data_access_hatch.tooltip.0"),
                    Component.translatable("gt6.machine.data_access_hatch.tooltip.1", 9),
                    Component.translatable("gt6.part_sharing.disabled"))
            .overlayTieredHullModel("data_access_hatch")
            .register();
    ...
    public static final MachineDefinition ADVANCED_DATA_ACCESS_HATCH = REGISTRATE
            ...
            .abilities(PartAbility.DATA_ACCESS)
            .tooltips(Component.translatable("gt6.machine.data_access_hatch.tooltip.0"),
                    Component.translatable("gt6.machine.data_access_hatch.tooltip.1", 16),
                    Component.translatable("gt6.part_sharing.disabled"))
            .overlayTieredHullModel("data_access_hatch")
            .register();
    ...
    public static final MachineDefinition CREATIVE_DATA_ACCESS_HATCH = REGISTRATE
            ...
            .tooltipBuilder((s, list) -> {
                list.add(Component.translatable("gt6.machine.data_access_hatch.tooltip.0"));
                CREATIVE_TOOLTIPS.accept(s, list);
                list.add(Component.translatable("gt6.part_sharing.enabled"));
            })
    ...
    public static final BiConsumer<ItemStack, List<Component>> OVERHEAT_TOOLTIPS = (stack, components) -> components
            .add(Component.translatable("gt6.machine.hpca.component_type.damaged")
    ...
    public static final MachineDefinition HPCA_COMPUTATION_COMPONENT = registerHPCAPart(
            ...
            .tooltips(
                    Component.translatable("gt6.machine.hpca.component_general.upkeep_eut", GTValues.VA[GTValues.EV]),
                    Component.translatable("gt6.machine.hpca.component_general.max_eut", GTValues.VA[GTValues.LuV]),
                    Component.translatable("gt6.machine.hpca.component_type.computation_cwut", 4),
                    Component.translatable("gt6.machine.hpca.component_type.computation_cooling", 2),
                    Component.translatable("gt6.part_sharing.disabled"))
    ...
    public static final MachineDefinition HPCA_ADVANCED_COMPUTATION_COMPONENT = registerHPCAPart(
            ...
            .tooltips(
                    Component.translatable("gt6.machine.hpca.component_general.upkeep_eut", GTValues.VA[GTValues.IV]),
                    Component.translatable("gt6.machine.hpca.component_general.max_eut", GTValues.VA[GTValues.ZPM]),
                    Component.translatable("gt6.machine.hpca.component_type.computation_cwut", 16),
                    Component.translatable("gt6.machine.hpca.component_type.computation_cooling", 4),
                    Component.translatable("gt6.part_sharing.disabled"))
            .tooltipBuilder(OVERHEAT_TOOLTIPS)
            .register();
    public static final MachineDefinition HPCA_HEAT_SINK_COMPONENT = registerHPCAPart(
            ...
            .tooltips(Component.translatable("gt6.machine.hpca.component_type.cooler_passive"),
                    Component.translatable("gt6.machine.hpca.component_type.cooler_cooling", 1),
                    Component.translatable("gt6.part_sharing.disabled"))
            .register();
    public static final MachineDefinition HPCA_ACTIVE_COOLER_COMPONENT = registerHPCAPart(
            ...
            .tooltips(Component.translatable("gt6.machine.hpca.component_general.max_eut", GTValues.VA[GTValues.IV]),
                    Component.translatable("gt6.machine.hpca.component_type.cooler_active"),
                    Component.translatable("gt6.machine.hpca.component_type.cooler_active_coolant",
                            8, GTMaterials.PCBCoolant.getLocalizedName()),
                    Component.translatable("gt6.machine.hpca.component_type.cooler_cooling", 2),
                    Component.translatable("gt6.part_sharing.disabled"))
            .register();
    public static final MachineDefinition HPCA_BRIDGE_COMPONENT = registerHPCAPart(
            ...
            .tooltips(Component.translatable("gt6.machine.hpca.component_type.bridge"),
                    Component.translatable("gt6.machine.hpca.component_general.max_eut", GTValues.VA[GTValues.IV]),
                    Component.translatable("gt6.part_sharing.disabled"))
            .register();
