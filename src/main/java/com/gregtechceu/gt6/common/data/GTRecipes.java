...
import com.gregtechceu.gt6.data.recipe.MaterialInfoLoader;
import com.gregtechceu.gt6.data.recipe.configurable.RecipeAddition;
import com.gregtechceu.gt6.data.recipe.configurable.RecipeRemoval;
import com.gregtechceu.gt6.data.recipe.generated.*;
import com.gregtechceu.gt6.data.recipe.misc.*;
import com.gregtechceu.gt6.data.recipe.serialized.chemistry.ChemistryRecipes;
...
public class GTRecipes {
    ...
    public static void recipeAddition(Consumer<FinishedRecipe> originalConsumer) {
        ...
        if (!(Gregtech.Mods.isKubeJSLoaded() && KJSCallWrapper.recipeEventHasListeners())) {
