...
public class SecondDegreeMaterials {
    ...
    public static void register() {
        Glass = new Material.Builder(Gregtech.id("glass"))
                .gem(0)
        ...
        Perlite = new Material.Builder(Gregtech.id("perlite"))
                .dust(1)
                .color(0xeee0e0).secondaryColor(0xc1b9a9)
                .components(Obsidian, 2, Water, 1)
                .buildAndRegister();

        ActivatedCarbon = new Material.Builder(Gregtech.id("activated_carbon"))
                .dust(1)
        ...
        Borax = new Material.Builder(Gregtech.id("borax"))
                .dust(1)
                .color(0xFAFAFA).secondaryColor(0xd7e7e7).iconSet(FINE)
                .components(Sodium, 2, Boron, 4, Water, 10, Oxygen, 7)
                .buildAndRegister();

        SaltWater = new Material.Builder(Gregtech.id("salt_water"))
                .fluid()
                .color(0x0000C8)
        ...
        Olivine = new Material.Builder(Gregtech.id("olivine"))
                .gem().ore(2, 1)
        ...
        Opal = new Material.Builder(Gregtech.id("opal"))
                .gem().ore()
        ...
        Amethyst = new Material.Builder(Gregtech.id("amethyst"))
                .gem(3).ore()
        ...
        EchoShard = new Material.Builder(Gregtech.id("echo_shard"))
                .gem(3)
        ...
        Lapis = new Material.Builder(Gregtech.id("lapis"))
                .gem(1).ore(6, 4)
        ...
        Blaze = new Material.Builder(Gregtech.id("blaze"))
                .dust(1)
                .liquid(new FluidBuilder()
                        .temperature(4000)
                        .customStill())
        ...
        Apatite = new Material.Builder(Gregtech.id("apatite"))
                .gem(1).ore(4, 2)
        ...
        BlackSteel = new Material.Builder(Gregtech.id("black_steel"))
                .ingot().fluid()
        ...
        DamascusSteel = new Material.Builder(Gregtech.id("damascus_steel"))
                .ingot(3).fluid()
        ...
        TungstenSteel = new Material.Builder(Gregtech.id("tungsten_steel"))
                .ingot(4).fluid()
        ...
        CobaltBrass = new Material.Builder(Gregtech.id("cobalt_brass"))
                .ingot()
        ...
        TricalciumPhosphate = new Material.Builder(Gregtech.id("tricalcium_phosphate"))
                .dust().ore(3, 1)
        ...
        GarnetRed = new Material.Builder(Gregtech.id("red_garnet"))
                .gem().ore(4, 1)
        ...
        GarnetYellow = new Material.Builder(Gregtech.id("yellow_garnet"))
                .gem().ore(4, 1)
        ...
        Marble = new Material.Builder(Gregtech.id("marble"))
                .dust()
        ...
        Deepslate = new Material.Builder(Gregtech.id("deepslate"))
                .dust()
        ...
        GraniteRed = new Material.Builder(Gregtech.id("granite_red"))
                .dust()
        ...
        VanadiumMagnetite = new Material.Builder(Gregtech.id("vanadium_magnetite"))
                .dust().ore()
        ...
        QuartzSand = new Material.Builder(Gregtech.id("quartz_sand"))
                .dust(1)
        ...
        Pollucite = new Material.Builder(Gregtech.id("pollucite"))
                .dust().ore()
                .color(0xeed9e1).secondaryColor(0x72a6a7)
                .components(Caesium, 2, Aluminium, 2, Silicon, 4, Water, 2, Oxygen, 12)
                .buildAndRegister();

        Bentonite = new Material.Builder(Gregtech.id("bentonite"))
                .dust().ore(3, 1)
        ...
        FullersEarth = new Material.Builder(Gregtech.id("fullers_earth"))
                .dust().ore(2, 1)
                .color(0xf3efbb).secondaryColor(0xb8d066).iconSet(FINE)
                .components(Magnesium, 1, Silicon, 4, Hydrogen, 1, Water, 4, Oxygen, 11)
                .buildAndRegister();

        Pitchblende = new Material.Builder(Gregtech.id("pitchblende"))
                .dust(3).ore(true)
        ...
        Monazite = new Material.Builder(Gregtech.id("monazite"))
                .gem(1).ore(4, 2, true)
        ...
        Mirabilite = new Material.Builder(Gregtech.id("mirabilite"))
                .dust()
                .color(0xf9e7e7).secondaryColor(0xb57a7a)
                .components(Sodium, 2, Sulfur, 1, Water, 10, Oxygen, 4)
                .buildAndRegister();

        Trona = new Material.Builder(Gregtech.id("trona"))
                .dust(1).ore(2, 1)
        ...
        Gypsum = new Material.Builder(Gregtech.id("gypsum"))
                .dust(1).ore()
                .color(0xfffaec).secondaryColor(0x71570a)
                .components(Calcium, 1, Sulfur, 1, Water, 2, Oxygen, 4)
                .buildAndRegister();

        Zeolite = new Material.Builder(Gregtech.id("zeolite"))
                .dust().ore(3, 1)
        ...
        Concrete = new Material.Builder(Gregtech.id("concrete"))
                .dust()
        ...
        SteelMagnetic = new Material.Builder(Gregtech.id("magnetic_steel"))
                .ingot()
        ...
        VanadiumSteel = new Material.Builder(Gregtech.id("vanadium_steel"))
                .ingot(3)
        ...
        Potin = new Material.Builder(Gregtech.id("potin"))
                .ingot()
        ...
        BorosilicateGlass = new Material.Builder(Gregtech.id("borosilicate_glass"))
                .ingot(1)
        ...
        Andesite = new Material.Builder(Gregtech.id("andesite"))
                .dust()
        ...
        NaquadahAlloy = new Material.Builder(Gregtech.id("naquadah_alloy"))
                .ingot(5).fluid()
        ...
        SulfuricNickelSolution = new Material.Builder(Gregtech.id("sulfuric_nickel_solution"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x3EB640)
                .components(Nickel, 1, Oxygen, 1, SulfuricAcid, 1)
                .buildAndRegister();

        SulfuricCopperSolution = new Material.Builder(Gregtech.id("sulfuric_copper_solution"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x48A5C0)
                .components(Copper, 1, Oxygen, 1, SulfuricAcid, 1)
                .buildAndRegister();

        LeadZincSolution = new Material.Builder(Gregtech.id("lead_zinc_solution"))
                .liquid(new FluidBuilder().customStill())
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .components(Lead, 1, Silver, 1, Zinc, 1, Sulfur, 3, Water, 1)
                .buildAndRegister();

        NitrationMixture = new Material.Builder(Gregtech.id("nitration_mixture"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xE6E2AB)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DilutedSulfuricAcid = new Material.Builder(Gregtech.id("diluted_sulfuric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xC07820)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DilutedHydrochloricAcid = new Material.Builder(Gregtech.id("diluted_hydrochloric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x99A7A3)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Flint = new Material.Builder(Gregtech.id("flint"))
                .gem(1)
        ...
        Air = new Material.Builder(Gregtech.id("air"))
        ...
        LiquidAir = new Material.Builder(Gregtech.id("liquid_air"))
        ...
        NetherAir = new Material.Builder(Gregtech.id("nether_air"))
                .gas()
                .color(0x4C3434)
                .flags(DISABLE_DECOMPOSITION)
        ...
        LiquidNetherAir = new Material.Builder(Gregtech.id("liquid_nether_air"))
        ...
        EnderAir = new Material.Builder(Gregtech.id("ender_air"))
                .gas()
                .color(0x283454)
                .flags(DISABLE_DECOMPOSITION)
        ...
        LiquidEnderAir = new Material.Builder(Gregtech.id("liquid_ender_air"))
        ...
        AquaRegia = new Material.Builder(Gregtech.id("aqua_regia"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xFFB132)
                .flags(DISABLE_DECOMPOSITION)
        ...
        PlatinumSludgeResidue = new Material.Builder(Gregtech.id("platinum_sludge_residue"))
                .dust()
        ...
        PalladiumRaw = new Material.Builder(Gregtech.id("palladium_raw"))
                .dust()
        ...
        RarestMetalMixture = new Material.Builder(Gregtech.id("rarest_metal_mixture"))
                .dust()
        ...
        AmmoniumChloride = new Material.Builder(Gregtech.id("ammonium_chloride"))
                .dust()
        ...
        AcidicOsmiumSolution = new Material.Builder(Gregtech.id("acidic_osmium_solution"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xDAC5C5)
                .flags(DISABLE_DECOMPOSITION)
        ...
        RhodiumPlatedPalladium = new Material.Builder(Gregtech.id("rhodium_plated_palladium"))
                .ingot().fluid()
        ...
        Clay = new Material.Builder(Gregtech.id("clay"))
                .dust(1)
        ...
        Redstone = new Material.Builder(Gregtech.id("redstone"))
                .dust().ore(5, 1, true)
        ...
        Dichloroethane = new Material.Builder(Gregtech.id("dichloroethane"))
                .liquid()
                .color(0xafc979)
        ...
        Diethylenetriamine = new Material.Builder(Gregtech.id("diethylenetriamine"))
                .liquid()
                .color(0xa9d9a7)
                .flags(DISABLE_DECOMPOSITION)
