...
import com.gregtechceu.gt6.common.data.GTRecipeModifiers;
import com.gregtechceu.gt6.common.data.GTRecipeTypes;
import com.gregtechceu.gt6.common.machine.multiblock.electric.DistillationTowerMachine;
import com.gregtechceu.gt6.common.machine.multiblock.electric.gcym.*;
import com.gregtechceu.gt6.common.machine.multiblock.part.ParallelHatchPartMachine;
...
import static com.gregtechceu.gt6.api.machine.multiblock.PartAbility.*;
...
import static com.gregtechceu.gt6.common.data.GCYMBlocks.*;
import static com.gregtechceu.gt6.common.data.GCYMRecipeTypes.ALLOY_BLAST_RECIPES;
import static com.gregtechceu.gt6.common.data.GTBlocks.*;
import static com.gregtechceu.gt6.common.data.GTMachines.*;
import static com.gregtechceu.gt6.common.data.GTMaterials.NaquadahAlloy;
...
import static com.gregtechceu.gt6.common.data.machines.GTMachineUtils.registerTieredMachines;
...
public class GCYMMachines {
    ...
    public static final MachineDefinition[] PARALLEL_HATCH = registerTieredMachines("parallel_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gt6.machine.parallel_hatch_mk" + tier + ".tooltip"),
    ...
    public final static MultiblockMachineDefinition LARGE_MACERATION_TOWER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.macerator")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_CHEMICAL_BATH = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.ore_washer"), Component.translatable("gt6.chemical_bath")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_CENTRIFUGE = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.centrifuge"), Component.translatable("gt6.thermal_centrifuge")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_MIXER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.mixer")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_ELECTROLYZER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.electrolyzer")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_ELECTROMAGNET = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.electromagnetic_separator"),
                    Component.translatable("gt6.polarizer")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_PACKER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.packer")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_ASSEMBLER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.multiblock.exact_hatch_1.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.assembler")))
    ...
    public final static MultiblockMachineDefinition LARGE_CIRCUIT_ASSEMBLER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.circuit_assembler")))
            .tooltips(Component.translatable("gt6.multiblock.exact_hatch_1.tooltip"))
            .conditionalTooltip(GTMachineUtils.defaultEnvironmentRequirement(),
                    ConfigHolder.INSTANCE.gameplay.environmentalHazards)
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_ARC_SMELTER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.arc_furnace")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_ENGRAVING_LASER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.laser_engraver")))
            .conditionalTooltip(GTMachineUtils.defaultEnvironmentRequirement(),
                    ConfigHolder.INSTANCE.gameplay.environmentalHazards)
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_SIFTING_FUNNEL = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.sifter")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition BLAST_ALLOY_SMELTER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.alloy_blast_smelter")))
    ...
    public final static MultiblockMachineDefinition LARGE_AUTOCLAVE = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.autoclave")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_MATERIAL_PRESS = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_4.tooltip",
                    Component.translatable("gt6.bender"), Component.translatable("gt6.compressor"),
                    Component.translatable("gt6.forge_hammer"), Component.translatable("gt6.forming_press")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_BREWER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_3.tooltip",
                    Component.translatable("gt6.brewery"), Component.translatable("gt6.fermenter"),
                    Component.translatable("gt6.fluid_heater")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_CUTTER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.cutter"), Component.translatable("gt6.lathe")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_DISTILLERY = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.distillation_tower"), Component.translatable("gt6.distillery")))
    ...
    public final static MultiblockMachineDefinition LARGE_EXTRACTOR = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.extractor"), Component.translatable("gt6.canner")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_EXTRUDER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.extruder")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_SOLIDIFIER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.fluid_solidifier")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition LARGE_WIREMILL = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.wiremill")))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition MEGA_BLAST_FURNACE = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.electric_blast_furnace")))
            .tooltips(Component.translatable("gt6.machine.electric_blast_furnace.tooltip.0"),
                    Component.translatable("gt6.machine.electric_blast_furnace.tooltip.1"),
                    Component.translatable("gt6.machine.electric_blast_furnace.tooltip.2"))
            .rotationState(RotationState.ALL)
    ...
    public final static MultiblockMachineDefinition MEGA_VACUUM_FREEZER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gt6.vacuum_freezer")))
            .rotationState(RotationState.ALL)
