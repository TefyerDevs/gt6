...
import com.gregtechceu.gt6.api.data.chemical.material.properties.BlastProperty.GasTier;
...
import static com.gregtechceu.gt6.api.GTValues.*;
...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        Asbestos = new Material.Builder(Gregtech.id("asbestos"))
                .dust(1).ore(3, 1)
        ...
        Ash = new Material.Builder(Gregtech.id("ash"))
                .dust(1)
        ...
        Hematite = new Material.Builder(Gregtech.id("hematite"))
                .dust().ore()
                .color(0xff7161).secondaryColor(0x330817)
                .components(Iron, 2, Oxygen, 3)
                .buildAndRegister();

        BatteryAlloy = new Material.Builder(Gregtech.id("battery_alloy"))
                .ingot(1)
        ...
        BlueTopaz = new Material.Builder(Gregtech.id("blue_topaz"))
                .gem(3).ore(2, 1)
        ...
        Bone = new Material.Builder(Gregtech.id("bone"))
                .dust(1)
        ...
        Brass = new Material.Builder(Gregtech.id("brass"))
                .ingot(1)
        ...
        Bronze = new Material.Builder(Gregtech.id("bronze"))
                .ingot()
        ...
        Goethite = new Material.Builder(Gregtech.id("goethite"))
                .dust(1).ore()
        ...
        Calcite = new Material.Builder(Gregtech.id("calcite"))
                .dust(1).ore()
                .color(0xfffef8).secondaryColor(0xbbaf62)
                .components(Calcium, 1, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        Cassiterite = new Material.Builder(Gregtech.id("cassiterite"))
                .dust(1).ore(2, 1)
                .color(0x89847e).secondaryColor(0x3b3b35).iconSet(ROUGH)
                .components(Tin, 1, Oxygen, 2)
                .buildAndRegister();

        CassiteriteSand = new Material.Builder(Gregtech.id("cassiterite_sand"))
                .dust(1).ore(2, 1)
                .color(0x89847e).secondaryColor(0x3b3b35).iconSet(SAND)
                .components(Tin, 1, Oxygen, 2)
                .buildAndRegister();

        Chalcopyrite = new Material.Builder(Gregtech.id("chalcopyrite"))
                .dust(1).ore()
                .color(0x96c185).secondaryColor(0xe3af1a)
                .components(Copper, 1, Iron, 1, Sulfur, 2)
                .buildAndRegister();

        Charcoal = new Material.Builder(Gregtech.id("charcoal"))
        ...
        Chromite = new Material.Builder(Gregtech.id("chromite"))
                .dust(1).ore()
                .color(0xc5c1a8).secondaryColor(0x4c1a69).iconSet(METALLIC)
                .components(Iron, 1, Chromium, 2, Oxygen, 4)
                .buildAndRegister();

        Cinnabar = new Material.Builder(Gregtech.id("cinnabar"))
                .gem(1).ore()
        ...
        Water = new Material.Builder(Gregtech.id("water"))
        ...
        Coal = new Material.Builder(Gregtech.id("coal"))
        ...
        DarkAsh = new Material.Builder(Gregtech.id("dark_ash"))
                .dust(1)
        ...
        Diamond = new Material.Builder(Gregtech.id("diamond"))
                .gem(3).ore()
        ...
        Electrum = new Material.Builder(Gregtech.id("electrum"))
                .ingot()
        ...
        Emerald = new Material.Builder(Gregtech.id("emerald"))
                .gem().ore(2, 1)
        ...
        Galena = new Material.Builder(Gregtech.id("galena"))
                .dust(3).ore()
        ...
        Garnierite = new Material.Builder(Gregtech.id("garnierite"))
                .dust(3).ore()
                .color(0x32c880).secondaryColor(0x344028).iconSet(METALLIC)
                .components(Nickel, 1, Oxygen, 1)
                .buildAndRegister();

        GreenSapphire = new Material.Builder(Gregtech.id("green_sapphire"))
                .gem().ore()
        ...
        Ilmenite = new Material.Builder(Gregtech.id("ilmenite"))
                .dust(3).ore()
        ...
        Rutile = new Material.Builder(Gregtech.id("rutile"))
                .gem()
        ...
        Bauxite = new Material.Builder(Gregtech.id("bauxite"))
                .dust(1).ore()
        ...
        Invar = new Material.Builder(Gregtech.id("invar"))
                .ingot()
        ...
        Kanthal = new Material.Builder(Gregtech.id("kanthal"))
                .ingot()
        ...
        Lazurite = new Material.Builder(Gregtech.id("lazurite"))
                .gem(1).ore(6, 4)
        ...
        Magnalium = new Material.Builder(Gregtech.id("magnalium"))
                .ingot()
        ...
        NiobiumNitride = new Material.Builder(Gregtech.id("niobium_nitride"))
                .ingot().fluid()
        ...
        NiobiumTitanium = new Material.Builder(Gregtech.id("niobium_titanium"))
                .ingot()
        ...
        Obsidian = new Material.Builder(Gregtech.id("obsidian"))
                .dust(3)
        ...
        Phosphate = new Material.Builder(Gregtech.id("phosphate"))
                .dust(1)
        ...
        PlatinumRaw = new Material.Builder(Gregtech.id("platinum_raw"))
                .dust()
        ...
        SterlingSilver = new Material.Builder(Gregtech.id("sterling_silver"))
                .ingot()
        ...
        RoseGold = new Material.Builder(Gregtech.id("rose_gold"))
                .ingot()
        ...
        BlackBronze = new Material.Builder(Gregtech.id("black_bronze"))
                .ingot()
        ...
        BismuthBronze = new Material.Builder(Gregtech.id("bismuth_bronze"))
                .ingot()
        ...
        Biotite = new Material.Builder(Gregtech.id("biotite"))
                .dust(1)
        ...
        Powellite = new Material.Builder(Gregtech.id("powellite"))
                .dust().ore()
                .color(0xd8cfac).secondaryColor(0xbc7a2c)
                .components(Calcium, 1, Molybdenum, 1, Oxygen, 4)
                .buildAndRegister();

        Pyrite = new Material.Builder(Gregtech.id("pyrite"))
                .dust(1).ore()
        ...
        RTMAlloy = new Material.Builder(Gregtech.id("rtm_alloy"))
                .ingot().fluid()
        ...
        Ruridit = new Material.Builder(Gregtech.id("ruridit"))
                .ingot(3)
                .fluid()
        ...
        Ruby = new Material.Builder(Gregtech.id("ruby"))
                .gem().ore()
        ...
        Salt = new Material.Builder(Gregtech.id("salt"))
                .gem(1).ore(2, 1)
        ...
        Saltpeter = new Material.Builder(Gregtech.id("saltpeter"))
                .dust(1).ore(2, 1)
        ...
        Sapphire = new Material.Builder(Gregtech.id("sapphire"))
                .gem().ore()
        ...
        Scheelite = new Material.Builder(Gregtech.id("scheelite"))
                .dust(3).ore()
        ...
        Sodalite = new Material.Builder(Gregtech.id("sodalite"))
                .gem(1).ore(6, 4)
        ...
        SolderingAlloy = new Material.Builder(Gregtech.id("soldering_alloy"))
                .ingot(1)
        ...
        Spessartine = new Material.Builder(Gregtech.id("spessartine"))
                .gem().ore(3, 1)
                .color(0xffa81e).secondaryColor(0xb33700).iconSet(RUBY)
                .components(Aluminium, 2, Manganese, 3, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        Sphalerite = new Material.Builder(Gregtech.id("sphalerite"))
                .dust(1).ore()
        ...
        StainlessSteel = new Material.Builder(Gregtech.id("stainless_steel"))
                .ingot(3)
        ...
        Steel = new Material.Builder(Gregtech.id("steel"))
                .ingot(3)
        ...
        Stibnite = new Material.Builder(Gregtech.id("stibnite"))
                .dust().ore()
        ...
        Tetrahedrite = new Material.Builder(Gregtech.id("tetrahedrite"))
                .dust().ore()
                .color(0xa3a09b).secondaryColor(0x143313)
                .components(Copper, 3, Antimony, 1, Sulfur, 3, Iron, 1)
                .buildAndRegister();

        TinAlloy = new Material.Builder(Gregtech.id("tin_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1258))
        ...
        Topaz = new Material.Builder(Gregtech.id("topaz"))
                .gem(3).ore()
        ...
        Tungstate = new Material.Builder(Gregtech.id("tungstate"))
                .dust(3).ore()
        ...
        Ultimet = new Material.Builder(Gregtech.id("ultimet"))
                .ingot(4)
        ...
        Uraninite = new Material.Builder(Gregtech.id("uraninite"))
                .dust(3).ore(true)
        ...
        Uvarovite = new Material.Builder(Gregtech.id("uvarovite"))
                .gem()
                .color(0x2ded4c).secondaryColor(0x00697c).iconSet(RUBY)
                .components(Calcium, 3, Chromium, 2, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        VanadiumGallium = new Material.Builder(Gregtech.id("vanadium_gallium"))
                .ingot()
        ...
        WroughtIron = new Material.Builder(Gregtech.id("wrought_iron"))
                .ingot()
                .liquid(new FluidBuilder().temperature(2011))
        ...
        Wulfenite = new Material.Builder(Gregtech.id("wulfenite"))
                .dust(3).ore()
                .color(0xff9000).secondaryColor(0xFF0000)
                .components(Lead, 1, Molybdenum, 1, Oxygen, 4)
                .buildAndRegister();

        Limonite = new Material.Builder(Gregtech.id("yellow_limonite"))
                .dust().ore()
        ...
        YttriumBariumCuprate = new Material.Builder(Gregtech.id("yttrium_barium_cuprate"))
                .ingot()
        ...
        NetherQuartz = new Material.Builder(Gregtech.id("nether_quartz"))
                .gem(1).ore(2, 1)
        ...
        CertusQuartz = new Material.Builder(Gregtech.id("certus_quartz"))
                .gem(1).ore(2, 1)
        ...
        Quartzite = new Material.Builder(Gregtech.id("quartzite"))
                .gem(1).ore(2, 1)
        ...
        Graphite = new Material.Builder(Gregtech.id("graphite"))
                .ore()
        ...
        Graphene = new Material.Builder(Gregtech.id("graphene"))
                .dust().ingot()
        ...
        TungsticAcid = new Material.Builder(Gregtech.id("tungstic_acid"))
                .dust()
        ...
        Osmiridium = new Material.Builder(Gregtech.id("osmiridium"))
                .ingot(3)
        ...
        Potash = new Material.Builder(Gregtech.id("potash"))
                .dust(1)
                .color(0xffa772).secondaryColor(0x922f1b).iconSet(FINE)
                .components(Potassium, 2, Oxygen, 1)
                .buildAndRegister();

        SodaAsh = new Material.Builder(Gregtech.id("soda_ash"))
                .dust(1)
                .color(0xffffff).secondaryColor(0xDCDCFF)
                .components(Sodium, 2, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        IndiumGalliumPhosphide = new Material.Builder(Gregtech.id("indium_gallium_phosphide"))
                .ingot(1)
        ...
        NickelZincFerrite = new Material.Builder(Gregtech.id("nickel_zinc_ferrite"))
                .ingot(0)
        ...
        SiliconDioxide = new Material.Builder(Gregtech.id("silicon_dioxide"))
                .dust(1)
        ...
        MagnesiumChloride = new Material.Builder(Gregtech.id("magnesium_chloride"))
                .dust(1)
        ...
        SodiumSulfide = new Material.Builder(Gregtech.id("sodium_sulfide"))
                .dust(1)
                .color(0xffd83d).secondaryColor(0xc54a00)
                .components(Sodium, 2, Sulfur, 1)
                .buildAndRegister();

        PhosphorusPentoxide = new Material.Builder(Gregtech.id("phosphorus_pentoxide"))
                .dust(1)
        ...
        Quicklime = new Material.Builder(Gregtech.id("quicklime"))
                .dust(1)
        ...
        SodiumBisulfate = new Material.Builder(Gregtech.id("sodium_bisulfate"))
                .dust(1)
        ...
        FerriteMixture = new Material.Builder(Gregtech.id("ferrite_mixture"))
                .dust(1)
        ...
        Magnesia = new Material.Builder(Gregtech.id("magnesia"))
                .dust(1)
                .color(0x998282).secondaryColor(0x594d19)
                .components(Magnesium, 1, Oxygen, 1)
                .buildAndRegister();

        PlatinumGroupSludge = new Material.Builder(Gregtech.id("platinum_group_sludge"))
                .dust(1)
                .color(0x343228).secondaryColor(0x001E00).iconSet(FINE)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Realgar = new Material.Builder(Gregtech.id("realgar"))
                .gem().ore()
        ...
        SodiumBicarbonate = new Material.Builder(Gregtech.id("sodium_bicarbonate"))
                .dust(1)
        ...
        PotassiumDichromate = new Material.Builder(Gregtech.id("potassium_dichromate"))
                .dust(1)
        ...
        ChromiumTrioxide = new Material.Builder(Gregtech.id("chromium_trioxide"))
                .dust(1)
                .color(0xFFE4E1)
        ...
        AntimonyTrioxide = new Material.Builder(Gregtech.id("antimony_trioxide"))
                .dust(1)
                .color(0xf5f5ff).secondaryColor(0xc4c4d6)
                .components(Antimony, 2, Oxygen, 3)
                .buildAndRegister();

        Zincite = new Material.Builder(Gregtech.id("zincite"))
                .dust(1)
                .color(0xff9f49).secondaryColor(0xff0000)
                .components(Zinc, 1, Oxygen, 1)
                .buildAndRegister();

        CupricOxide = new Material.Builder(Gregtech.id("cupric_oxide"))
                .dust(1)
                .color(0x8df7cf).secondaryColor(0x57696e)
                .components(Copper, 1, Oxygen, 1)
                .buildAndRegister();

        CobaltOxide = new Material.Builder(Gregtech.id("cobalt_oxide"))
                .dust(1)
                .color(0x3cb099).secondaryColor(0x3b5c66)
                .components(Cobalt, 1, Oxygen, 1)
                .buildAndRegister();

        ArsenicTrioxide = new Material.Builder(Gregtech.id("arsenic_trioxide"))
                .dust(1)
                .color(0xf9f3f3).secondaryColor(0x3b5c66).iconSet(ROUGH)
                .components(Arsenic, 2, Oxygen, 3)
                .buildAndRegister();

        Massicot = new Material.Builder(Gregtech.id("massicot"))
                .dust(1)
                .color(0xFFDD55).secondaryColor(0x000000)
                .components(Lead, 1, Oxygen, 1)
                .buildAndRegister();

        Ferrosilite = new Material.Builder(Gregtech.id("ferrosilite"))
                .dust(1)
                .color(0x968c80).secondaryColor(0x97732a)
                .components(Iron, 1, Silicon, 1, Oxygen, 3)
                .buildAndRegister();

        MetalMixture = new Material.Builder(Gregtech.id("metal_mixture"))
                .dust(1)
                .color(0x697077).secondaryColor(0x502d16).iconSet(METALLIC)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        SodiumHydroxide = new Material.Builder(Gregtech.id("sodium_hydroxide"))
                .dust(1)
        ...
        TungstenCarbide = new Material.Builder(Gregtech.id("tungsten_carbide"))
                .ingot(4).fluid()
        ...
        CarbonDioxide = new Material.Builder(Gregtech.id("carbon_dioxide"))
                .gas()
                .color(0xA9D0F5)
                .components(Carbon, 1, Oxygen, 2)
                .buildAndRegister();

        TitaniumTetrachloride = new Material.Builder(Gregtech.id("titanium_tetrachloride"))
                .liquid(new FluidBuilder().customStill())
                .color(0xD40D5C)
                .flags(DISABLE_DECOMPOSITION)
        ...
        NitrogenDioxide = new Material.Builder(Gregtech.id("nitrogen_dioxide"))
                .gas()
                .color(0x85FCFF)
        ...
        HydrogenSulfide = new Material.Builder(Gregtech.id("hydrogen_sulfide"))
        ...
        NitricAcid = new Material.Builder(Gregtech.id("nitric_acid"))
        ...
        SulfuricAcid = new Material.Builder(Gregtech.id("sulfuric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .flags(DISABLE_DECOMPOSITION)
                .components(Hydrogen, 2, Sulfur, 1, Oxygen, 4)
                .buildAndRegister();

        PhosphoricAcid = new Material.Builder(Gregtech.id("phosphoric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xDCDC01)
                .flags(DISABLE_DECOMPOSITION)
        ...
        SulfurTrioxide = new Material.Builder(Gregtech.id("sulfur_trioxide"))
                .gas()
                .color(0xA0A014)
        ...
        SulfurDioxide = new Material.Builder(Gregtech.id("sulfur_dioxide"))
                .gas()
                .color(0x0E4880)
        ...
        CarbonMonoxide = new Material.Builder(Gregtech.id("carbon_monoxide"))
                .gas()
                .color(0x0E4880)
        ...
        HypochlorousAcid = new Material.Builder(Gregtech.id("hypochlorous_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x6F8A91)
                .components(Hydrogen, 1, Chlorine, 1, Oxygen, 1)
                .buildAndRegister();

        Ammonia = new Material.Builder(Gregtech.id("ammonia"))
                .gas()
                .color(0x4465a2).secondaryColor(0x3F3480)
                .components(Nitrogen, 1, Hydrogen, 3)
                .buildAndRegister();

        HydrofluoricAcid = new Material.Builder(Gregtech.id("hydrofluoric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x0088AA)
        ...
        NitricOxide = new Material.Builder(Gregtech.id("nitric_oxide"))
                .gas()
                .color(0x7DC8F0)
        ...
        Iron3Chloride = new Material.Builder(Gregtech.id("iron_iii_chloride"))
                .liquid()
                .color(0x060B0B)
        ...
        Iron2Chloride = new Material.Builder(Gregtech.id("iron_ii_chloride"))
                .liquid()
                .color(0xe8e0be)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
        ...
        UraniumHexafluoride = new Material.Builder(Gregtech.id("uranium_hexafluoride"))
                .gas()
                .color(0x42D126)
                .flags(DISABLE_DECOMPOSITION)
        ...
        EnrichedUraniumHexafluoride = new Material.Builder(Gregtech.id("enriched_uranium_hexafluoride"))
                .gas()
                .color(0x4BF52A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DepletedUraniumHexafluoride = new Material.Builder(Gregtech.id("depleted_uranium_hexafluoride"))
                .gas()
                .color(0x74BA66)
                .flags(DISABLE_DECOMPOSITION)
                .components(Uranium238, 1, Fluorine, 6)
        ...
        NitrousOxide = new Material.Builder(Gregtech.id("nitrous_oxide"))
                .gas()
                .color(0x7DC8FF)
        ...
        EnderPearl = new Material.Builder(Gregtech.id("ender_pearl"))
                .gem(1)
        ...
        PotassiumFeldspar = new Material.Builder(Gregtech.id("potassium_feldspar"))
                .dust(1)
                .color(0xffe3bc).secondaryColor(0xd4918a).iconSet(FINE)
                .components(Potassium, 1, Aluminium, 1, Silicon, 1, Oxygen, 8)
                .buildAndRegister();

        NeodymiumMagnetic = new Material.Builder(Gregtech.id("magnetic_neodymium"))
                .ingot()
        ...
        HydrochloricAcid = new Material.Builder(Gregtech.id("hydrochloric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .components(Hydrogen, 1, Chlorine, 1)
                .buildAndRegister();

        Steam = new Material.Builder(Gregtech.id("steam"))
        ...
        DistilledWater = new Material.Builder(Gregtech.id("distilled_water"))
                .fluid()
                .color(0x4A94FF)
                .flags(DISABLE_DECOMPOSITION)
                .components(Hydrogen, 2, Oxygen, 1)
        ...
        SodiumPotassium = new Material.Builder(Gregtech.id("sodium_potassium"))
                .fluid()
                .color(0x64FCB4)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        SamariumMagnetic = new Material.Builder(Gregtech.id("magnetic_samarium"))
                .ingot()
        ...
        ManganesePhosphide = new Material.Builder(Gregtech.id("manganese_phosphide"))
                .ingot()
        ...
        MagnesiumDiboride = new Material.Builder(Gregtech.id("magnesium_diboride"))
                .ingot()
        ...
        MercuryBariumCalciumCuprate = new Material.Builder(Gregtech.id("mercury_barium_calcium_cuprate"))
                .ingot()
        ...
        UraniumTriplatinum = new Material.Builder(Gregtech.id("uranium_triplatinum"))
                .ingot()
        ...
        SamariumIronArsenicOxide = new Material.Builder(Gregtech.id("samarium_iron_arsenic_oxide"))
                .ingot()
        ...
        IndiumTinBariumTitaniumCuprate = new Material.Builder(Gregtech.id("indium_tin_barium_titanium_cuprate"))
                .ingot()
        ...
        UraniumRhodiumDinaquadide = new Material.Builder(Gregtech.id("uranium_rhodium_dinaquadide"))
                .ingot()
        ...
        EnrichedNaquadahTriniumEuropiumDuranide = new Material.Builder(
                Gregtech.id("enriched_naquadah_trinium_europium_duranide"))
                .ingot()
        ...
        RutheniumTriniumAmericiumNeutronate = new Material.Builder(Gregtech.id("ruthenium_trinium_americium_neutronate"))
                .ingot()
        ...
        InertMetalMixture = new Material.Builder(Gregtech.id("inert_metal_mixture"))
                .dust()
        ...
        RhodiumSulfate = new Material.Builder(Gregtech.id("rhodium_sulfate"))
        ...
        RutheniumTetroxide = new Material.Builder(Gregtech.id("ruthenium_tetroxide"))
                .dust()
        ...
        OsmiumTetroxide = new Material.Builder(Gregtech.id("osmium_tetroxide"))
                .dust()
        ...
        IridiumChloride = new Material.Builder(Gregtech.id("iridium_chloride"))
                .dust()
        ...
        FluoroantimonicAcid = new Material.Builder(Gregtech.id("fluoroantimonic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .components(Hydrogen, 2, Antimony, 1, Fluorine, 7)
                .buildAndRegister();

        TitaniumTrifluoride = new Material.Builder(Gregtech.id("titanium_trifluoride"))
                .dust()
        ...
        CalciumPhosphide = new Material.Builder(Gregtech.id("calcium_phosphide"))
                .dust()
                .color(0xFFF5DE).secondaryColor(0xf6baba).iconSet(METALLIC)
                .components(Calcium, 1, Phosphorus, 1)
                .buildAndRegister();

        IndiumPhosphide = new Material.Builder(Gregtech.id("indium_phosphide"))
                .dust()
        ...
        BariumSulfide = new Material.Builder(Gregtech.id("barium_sulfide"))
                .dust()
                .color(0x80784a).secondaryColor(0x2c333b).iconSet(METALLIC)
                .components(Barium, 1, Sulfur, 1)
                .buildAndRegister();

        TriniumSulfide = new Material.Builder(Gregtech.id("trinium_sulfide"))
                .dust()
        ...
        ZincSulfide = new Material.Builder(Gregtech.id("zinc_sulfide"))
                .dust()
                .color(0xfff4d5).secondaryColor(0xdadada)
                .components(Zinc, 1, Sulfur, 1)
                .buildAndRegister();

        GalliumSulfide = new Material.Builder(Gregtech.id("gallium_sulfide"))
                .dust()
                .color(0xffee5d).secondaryColor(0xedf008).iconSet(SHINY)
                .components(Gallium, 1, Sulfur, 1)
                .buildAndRegister();

        AntimonyTrifluoride = new Material.Builder(Gregtech.id("antimony_trifluoride"))
                .dust()
        ...
        EnrichedNaquadahSulfate = new Material.Builder(Gregtech.id("enriched_naquadah_sulfate"))
                .dust()
        ...
        NaquadriaSulfate = new Material.Builder(Gregtech.id("naquadria_sulfate"))
                .dust()
        ...
        Pyrochlore = new Material.Builder(Gregtech.id("pyrochlore"))
                .dust().ore()
                .color(0x5b4838).secondaryColor(0x331400).iconSet(METALLIC)
                .components(Calcium, 2, Niobium, 2, Oxygen, 7)
                .buildAndRegister();

        PotassiumHydroxide = new Material.Builder(Gregtech.id("potassium_hydroxide"))
                .dust(1)
        ...
        PotassiumIodide = new Material.Builder(Gregtech.id("potassium_iodide"))
                .dust()
                .color(0xa66c71).secondaryColor(0x802d67).iconSet(METALLIC)
                .components(Potassium, 1, Iodine, 1)
                .buildAndRegister();

        PotassiumCarbonate = new Material.Builder(Gregtech.id("potassium_carbonate"))
                .dust()
                .color(0xa66c71).secondaryColor(0x802d67).iconSet(METALLIC)
                .components(Potassium, 2, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        PotassiumFerrocyanide = new Material.Builder(Gregtech.id("potassium_ferrocyanide"))
                .dust()
        ...
        CalciumFerrocyanide = new Material.Builder(Gregtech.id("calcium_ferrocyanide"))
                .dust()
                .color(0xc9a842).secondaryColor(0x947110).iconSet(DULL)
        ...
        CalciumHydroxide = new Material.Builder(Gregtech.id("calcium_hydroxide"))
                .dust()
        ...
        CalciumCarbonate = new Material.Builder(Gregtech.id("calcium_carbonate"))
                .dust()
                .color(0xd9ca9c).secondaryColor(0xad913b)
                .components(Calcium, 2, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        PotassiumCyanide = new Material.Builder(Gregtech.id("potassium_cyanide"))
                .dust()
        ...
        HydrogenCyanide = new Material.Builder(Gregtech.id("hydrogen_cyanide"))
                .gas()
                .color(0x72dbd4)
        ...
        FormicAcid = new Material.Builder(Gregtech.id("formic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xa6a6a6)
        ...
        PotassiumSulfate = new Material.Builder(Gregtech.id("potassium_sulfate"))
                .dust()
        ...
        PrussianBlue = new Material.Builder(Gregtech.id("prussian_blue"))
                .dust()
        ...
        Formaldehyde = new Material.Builder(Gregtech.id("formaldehyde"))
                .liquid()
                .color(0xddeced)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
        ...
        Glycolonitrile = new Material.Builder(Gregtech.id("glycolonitrile"))
                .liquid()
                .color(0x5b8c8f)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DiethylenetriaminePentaacetonitrile = new Material.Builder(Gregtech.id("diethylenetriamine_pentaacetonitrile"))
                .liquid()
                .color(0xcbbfd6)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DiethylenetriaminepentaaceticAcid = new Material.Builder(Gregtech.id("diethylenetriaminepentaacetic_acid"))
                .dust()
        ...
        SodiumNitrite = new Material.Builder(Gregtech.id("sodium_nitrite"))
                .dust()
        ...
        HydrogenPeroxide = new Material.Builder(Gregtech.id("hydrogen_peroxide"))
                .liquid()
                .color(0x0cbdd7)
        ...
        IlmeniteSlag = new Material.Builder(Gregtech.id("ilmenite_slag"))
                .dust()
