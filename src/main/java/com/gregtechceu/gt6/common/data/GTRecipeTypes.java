...
import com.gregtechceu.gt6.api.recipe.*;
...
import com.gregtechceu.gt6.api.sound.ExistingSoundEntry;
import com.gregtechceu.gt6.api.transfer.fluid.CustomFluidTank;
import com.gregtechceu.gt6.common.machine.multiblock.electric.FusionReactorMachine;
import com.gregtechceu.gt6.common.machine.trait.customlogic.*;
import com.gregtechceu.gt6.common.recipe.condition.RockBreakerCondition;
...
public class GTRecipeTypes {
    ...
    public final static GTRecipeType MACERATOR_RECIPES = register("macerator", ELECTRIC).setMaxIOSize(1, 4, 0, 0)
            ...
            .addDataInfo(data -> LocalizationUtils.format("gt6.recipe.byproduct_tier", GTValues.VNF[GTValues.HV]));
    ...
    public final static GTRecipeType BLAST_RECIPES = register("electric_blast_furnace", MULTIBLOCK)
            ...
            .addDataInfo(data -> {
                ...
                return LocalizationUtils.format("gt6.recipe.temperature", temp);
            })
            .addDataInfo(data -> {
                int temp = data.getInt("ebf_temp");
                ...
                if (requiredCoil != null && !requiredCoil.getMaterial().isNull()) {
                    return LocalizationUtils.format("gt6.recipe.coil.tier",
    ...
    public static GTRecipeType register(String name, String group, RecipeType<?>... proxyRecipes) {
        var recipeType = new GTRecipeType(Gregtech.id(name), group, proxyRecipes);
    ...
    public static void init() {
        ...
        GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, Gregtech.id("crafting_facade_cover"),
                FacadeCoverRecipe.SERIALIZER);
        GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, Gregtech.id("crafting_shaped_strict"),
                StrictShapedRecipe.SERIALIZER);
        GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, Gregtech.id("crafting_shaped_energy_transfer"),
                ShapedEnergyTransferRecipe.SERIALIZER);
        GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, Gregtech.id("crafting_tool_head_replace"),
                ToolHeadReplaceRecipe.SERIALIZER);
        GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, Gregtech.id("crafting_shaped_fluid_container"),
                ShapedFluidContainerRecipe.SERIALIZER);
    }

    public static GTRecipeType get(String name) {
        return GTRegistries.RECIPE_TYPES.get(Gregtech.id(name));
    }
}
