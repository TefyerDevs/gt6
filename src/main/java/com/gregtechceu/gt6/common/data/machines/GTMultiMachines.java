...
import com.gregtechceu.gt6.api.machine.multiblock.CoilWorkableElectricMultiblockMachine;
...
import com.gregtechceu.gt6.api.pattern.MultiblockShapeInfo;
...
import com.gregtechceu.gt6.common.machine.multiblock.electric.*;
import com.gregtechceu.gt6.common.machine.multiblock.electric.BedrockOreMinerMachine;
import com.gregtechceu.gt6.common.machine.multiblock.primitive.CharcoalPileIgniterMachine;
import com.gregtechceu.gt6.common.machine.multiblock.primitive.CokeOvenMachine;
import com.gregtechceu.gt6.common.machine.multiblock.primitive.PrimitiveBlastFurnaceMachine;
...
import static com.gregtechceu.gt6.api.pattern.util.RelativeDirection.*;
import static com.gregtechceu.gt6.common.data.GTBlocks.*;
import static com.gregtechceu.gt6.common.data.GTMachines.*;
import static com.gregtechceu.gt6.common.data.GTMaterials.DrillingFluid;
...
import static com.gregtechceu.gt6.utils.FormattingUtil.toRomanNumeral;
...
public class GTMultiMachines {
    ...
    public static final MultiblockMachineDefinition PYROLYSE_OVEN = REGISTRATE
            ...
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
                    components.add(Component.translatable("gt6.multiblock.pyrolyse_oven.speed",
    ...
    public static final MultiblockMachineDefinition MULTI_SMELTER = REGISTRATE
            ...
            .appearanceBlock(CASING_INVAR_HEATPROOF)
            .tooltips(Component.translatable("gt6.machine.available_recipe_map_2.tooltip",
                    Component.translatable("gt6.electric_furnace"), Component.translatable("gt6.alloy_smelter")))
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("XXX", "CCC", "XXX")
                    .aisle("XXX", "C#C", "XMX")
                    .aisle("XSX", "CCC", "XXX")
            ...
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
                    ...
                    components.add(Component.translatable("gt6.multiblock.multi_furnace.heating_coil_discount",
    ...
    public static final MultiblockMachineDefinition CRACKER = REGISTRATE
            ...
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
                    components.add(Component.translatable("gt6.multiblock.cracking_unit.energy",
            ...
            .pattern(definition -> FactoryBlockPattern.start(BACK, UP, RIGHT)
                    ...
                    .where('O',
                            Predicates.abilities(PartAbility.EXPORT_ITEMS)
                                    .addTooltips(Component.translatable("gt6.multiblock.pattern.location_end")))
                    .where('Y',
    ...
    public static final MultiblockMachineDefinition[] FUSION_REACTOR = registerTieredMultis("fusion_reactor",
            FusionReactorMachine::new, (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.machine.fusion_reactor.capacity",
                                    FusionReactorMachine.calculateEnergyStorageFactor(tier, 16) / 1000000L),
                            Component.translatable("gt6.machine.fusion_reactor.overclocking"),
                            Component.translatable("gt6.multiblock.%s_fusion_reactor.description"
    ...
    public static final MultiblockMachineDefinition[] FLUID_DRILLING_RIG = registerTieredMultis(
            "fluid_drilling_rig", FluidDrillMachine::new, (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.machine.fluid_drilling_rig.description"),
                            Component.translatable("gt6.machine.fluid_drilling_rig.depletion",
                                    FormattingUtil.formatNumbers(100.0 / FluidDrillMachine.getDepletionChance(tier))),
                            Component.translatable("gt6.universal.tooltip.energy_tier_range", GTValues.VNF[tier],
                                    GTValues.VNF[tier + 1]),
                            Component.translatable("gt6.machine.fluid_drilling_rig.production",
    ...
    public static final MultiblockMachineDefinition[] LARGE_MINER = registerTieredMultis("large_miner",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(
                            Component.translatable("gt6.machine.large_miner.%s.tooltip"
                                    .formatted(VN[tier].toLowerCase(Locale.ROOT))),
                            Component.translatable("gt6.machine.miner.multi.description"))
                    .tooltipBuilder((stack, tooltip) -> {
                        int workingAreaChunks = (2 * tier - 5);
                        tooltip.add(Component.translatable("gt6.machine.miner.multi.modes"));
                        tooltip.add(Component.translatable("gt6.machine.miner.multi.production"));
                        tooltip.add(Component.translatable("gt6.machine.miner.fluid_usage", 8 - (tier - 5),
                                DrillingFluid.getLocalizedName()));
                        tooltip.add(Component.translatable("gt6.universal.tooltip.working_area_chunks",
                                workingAreaChunks, workingAreaChunks));
                        tooltip.add(Component.translatable("gt6.universal.tooltip.energy_tier_range",
    ...
    public static final MultiblockMachineDefinition CLEANROOM = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.cleanroom.tooltip.0"),
                    Component.translatable("gt6.machine.cleanroom.tooltip.1"),
                    Component.translatable("gt6.machine.cleanroom.tooltip.2"),
                    Component.translatable("gt6.machine.cleanroom.tooltip.3"))
            .tooltipBuilder((stack, tooltip) -> {
                if (GTUtil.isCtrlDown()) {
                    tooltip.add(Component.empty());
                    tooltip.add(Component.translatable("gt6.machine.cleanroom.tooltip.4"));
                    tooltip.add(Component.translatable("gt6.machine.cleanroom.tooltip.5"));
                    ...
                    if (Gregtech.Mods.isAE2Loaded()) {
                        tooltip.add(
                                Component.translatable(AEConfig.instance().getChannelMode() == ChannelMode.INFINITE ?
                                        ...
                                        "gt6.machine.cleanroom.tooltip.ae2.channels"));
                    }
                    tooltip.add(Component.empty());
                } else {
                    tooltip.add(Component.translatable("gt6.machine.cleanroom.tooltip.hold_ctrl"));
                }
            })
            .pattern((definition) -> FactoryBlockPattern.start()
    ...
    public static final MultiblockMachineDefinition ACTIVE_TRANSFORMER = REGISTRATE
            ...
            .tooltips(Component.translatable("gt6.machine.active_transformer.tooltip.0"),
                    Component.translatable("gt6.machine.active_transformer.tooltip.1"))
            .tooltipBuilder(
                    (stack,
                     components) -> components.add(Component.translatable("gt6.machine.active_transformer.tooltip.2")
                             .append(Component.translatable("gt6.machine.active_transformer.tooltip.3")
    ...
    public static final MultiblockMachineDefinition POWER_SUBSTATION = REGISTRATE
            ...
            .rotationState(RotationState.ALL)
            .recipeType(GTRecipeTypes.DUMMY_RECIPES)
            .tooltips(Component.translatable("gt6.machine.power_substation.tooltip.0"),
                    Component.translatable("gt6.machine.power_substation.tooltip.1"),
                    Component.translatable("gt6.machine.power_substation.tooltip.2",
                            PowerSubstationMachine.MAX_BATTERY_LAYERS),
                    Component.translatable("gt6.machine.power_substation.tooltip.3"),
                    Component.translatable("gt6.machine.power_substation.tooltip.4",
                            PowerSubstationMachine.PASSIVE_DRAIN_MAX_PER_STORAGE / 1000))
            .tooltipBuilder(
                    (stack,
                     components) -> components.add(Component.translatable("gt6.machine.power_substation.tooltip.5")
                             .append(Component.translatable("gt6.machine.power_substation.tooltip.6")
                                     .withStyle(TooltipHelper.RAINBOW_HSL_SLOW))))
    ...
    public static MultiblockMachineDefinition[] BEDROCK_ORE_MINER = registerTieredMultis(
            "bedrock_ore_miner", BedrockOreMinerMachine::new, (tier, builder) -> builder
                    ...
                    .recipeType(DUMMY_RECIPES)
                    .tooltips(
                            Component.translatable("gt6.machine.bedrock_ore_miner.description"),
                            Component.translatable("gt6.machine.bedrock_ore_miner.depletion",
                                    FormattingUtil.formatNumbers(
                                            100.0 / BedrockOreMinerMachine.getDepletionChance(tier))),
                            Component.translatable("gt6.universal.tooltip.energy_tier_range",
                                    GTValues.VNF[tier], GTValues.VNF[tier + 1]),
                            Component.translatable("gt6.machine.bedrock_ore_miner.production",
