package com.gregtechceu.gt6.common.item.tool.behavior;
...
public class MetaMachineConfigCopyBehaviour implements IInteractionItem, IAddInformation {
    ...
    public static final Component[] DIRECTION_TOOLTIPS = {
            Component.translatable("gt6.direction.tooltip.up").withStyle(ChatFormatting.YELLOW),
            Component.translatable("gt6.direction.tooltip.down").withStyle(ChatFormatting.YELLOW),
            Component.translatable("gt6.direction.tooltip.left").withStyle(ChatFormatting.YELLOW),
            Component.translatable("gt6.direction.tooltip.right").withStyle(ChatFormatting.YELLOW),
            Component.translatable("gt6.direction.tooltip.front").withStyle(ChatFormatting.YELLOW),
            Component.translatable("gt6.direction.tooltip.back").withStyle(ChatFormatting.YELLOW),
    };
