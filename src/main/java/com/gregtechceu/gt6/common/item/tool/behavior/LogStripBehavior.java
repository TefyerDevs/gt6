...
public class LogStripBehavior implements IToolBehavior {
    ...
    public InteractionResult onItemUse(UseOnContext context) {
        ...
        if (stripped) {
            level.playSound(player, blocks.get(0), SoundEvents.AXE_STRIP, SoundSource.BLOCKS, 1.0F, 1.0F);
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable Level Level, @NotNull List<Component> tooltip,
        ...
        tooltip.add(Component.translatable("item.gt6.tool.behavior.strip_log"));
    }
}
