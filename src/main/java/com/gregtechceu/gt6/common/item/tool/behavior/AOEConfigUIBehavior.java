...
import static com.gregtechceu.gt6.api.item.tool.ToolHelper.getMaxAoEDefinition;
...
public class AOEConfigUIBehavior implements IToolUIBehavior {
    ...
    public ModularUI createUI(Player player, HeldItemUIFactory.HeldItemHolder holder) {
        ...
        return new ModularUI(120, 80, holder, player).background(GuiTextures.BACKGROUND)
                .widget(new LabelWidget(6, 10, "item.gt6.tool.aoe.columns"))
                .widget(new LabelWidget(49, 10, "item.gt6.tool.aoe.rows"))
                .widget(new LabelWidget(79, 10, "item.gt6.tool.aoe.layers"))
