package com.gregtechceu.gt6.common.machine.steam;
...
import com.gregtechceu.gt6.api.gui.widget.PredicatedImageWidget;
...
import com.gregtechceu.gt6.api.machine.feature.*;
import com.gregtechceu.gt6.api.machine.steam.SteamWorkableMachine;
...
import com.gregtechceu.gt6.common.machine.trait.miner.SteamMinerLogic;
...
public class SteamMinerMachine extends SteamWorkableMachine implements IMiner, IControllable, IExhaustVentMachine,
    ...
    void addDisplayText(List<Component> textList) {
        ...
        textList.add(Component.translatable("gt6.machine.miner.startx", this.getRecipeLogic().getX()));
        textList.add(Component.translatable("gt6.machine.miner.starty", this.getRecipeLogic().getY()));
        textList.add(Component.translatable("gt6.machine.miner.startz", this.getRecipeLogic().getZ()));
        textList.add(Component.translatable("gt6.universal.tooltip.working_area", workingArea, workingArea));
        if (this.getRecipeLogic().isDone())
            textList.add(Component.translatable("gt6.multiblock.large_miner.done")
                    .withStyle(ChatFormatting.GREEN));
        else if (this.getRecipeLogic().isWorking())
            textList.add(Component.translatable("gt6.multiblock.large_miner.working")
                    .withStyle(ChatFormatting.GOLD));
        else if (!this.isWorkingEnabled())
            textList.add(Component.translatable("gt6.multiblock.work_paused"));
        if (getRecipeLogic().isInventoryFull())
            textList.add(Component.translatable("gt6.multiblock.large_miner.invfull")
                    .withStyle(ChatFormatting.RED));
        if (isVentingBlocked())
            textList.add(Component.translatable("gt6.multiblock.large_miner.vent")
                    .withStyle(ChatFormatting.RED));
        else if (!drainInput(true))
            textList.add(Component.translatable("gt6.multiblock.large_miner.steam")
                    .withStyle(ChatFormatting.RED));
    }

    void addDisplayText2(List<Component> textList) {
        textList.add(Component.translatable("gt6.machine.miner.minex", this.getRecipeLogic().getMineX()));
        textList.add(Component.translatable("gt6.machine.miner.miney", this.getRecipeLogic().getMineY()));
        textList.add(Component.translatable("gt6.machine.miner.minez", this.getRecipeLogic().getMineZ()));
    }
    ...
    public List<Component> getDataInfo(PortableScannerBehavior.DisplayMode mode) {
        if (mode == PortableScannerBehavior.DisplayMode.SHOW_ALL ||
            ...
            return Collections.singletonList(
                    Component.translatable("gt6.universal.tooltip.working_area", workingArea, workingArea));
        }
