...
import com.gregtechceu.gt6.api.gui.widget.PhantomSlotWidget;
...
import com.gregtechceu.gt6.api.machine.TieredMachine;
...
public class QuantumChestMachine extends TieredMachine implements IAutoOutputItem, IInteractedMachine, IControllable,
                ...
                if (isAllowInputFromOutputSideItems()) {
                    ...
                    playerIn.sendSystemMessage(
                            Component.translatable("gt6.machine.basic.input_from_output_side.disallow")
                                    .append(Component.translatable("gt6.creative.chest.item")));
                } else {
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new ImageWidget(4, 4, 81, 55, GuiTextures.DISPLAY))
                .addWidget(new LabelWidget(8, 8, "gt6.machine.quantum_chest.items_stored"))
