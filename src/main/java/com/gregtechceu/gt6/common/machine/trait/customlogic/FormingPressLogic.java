...
public enum FormingPressLogic implements GTRecipeType.ICustomRecipeLogic {
    ...
    public void buildRepresentativeRecipes() {
        ...
        press.setHoverName(Component.translatable("gt6.forming_press.naming.press"));
        ItemStack toName = new ItemStack(Items.NAME_TAG);
        toName.setHoverName(Component.translatable("gt6.forming_press.naming.to_name"));
        ItemStack named = new ItemStack(Items.NAME_TAG);
        named.setHoverName(Component.translatable("gt6.forming_press.naming.named"));
