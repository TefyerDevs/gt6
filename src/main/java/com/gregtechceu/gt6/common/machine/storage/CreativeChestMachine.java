...
public class CreativeChestMachine extends QuantumChestMachine {
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new LabelWidget(7, 9, "gt6.creative.chest.item"));
        ...
        group.addWidget(new LabelWidget(7, 28, "gt6.creative.chest.ipc"));
        ...
        group.addWidget(new TextFieldWidget(9, 87, 152, 10, () -> String.valueOf(ticksPerCycle), this::setTicksPerCycle)
                .setMaxStringLength(11)
                .setNumbersOnly(1, Integer.MAX_VALUE));
        group.addWidget(new LabelWidget(7, 65, "gt6.creative.chest.tpc"));
