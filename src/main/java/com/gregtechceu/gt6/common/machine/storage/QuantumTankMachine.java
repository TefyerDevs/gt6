...
import com.gregtechceu.gt6.api.gui.widget.PhantomFluidWidget;
...
import com.gregtechceu.gt6.api.machine.feature.IDropSaveMachine;
...
public class QuantumTankMachine extends TieredMachine implements IAutoOutputFluid, IInteractedMachine, IControllable,
            ...
            if (gridSide == getOutputFacingFluids()) {
                if (isAllowInputFromOutputSideFluids()) {
                    ...
                    playerIn.sendSystemMessage(
                            Component.translatable("gt6.machine.basic.input_from_output_side.disallow")
                                    .append(Component.translatable("gt6.creative.tank.fluid")));
                } else {
                    setAllowInputFromOutputSideFluids(true);
                    playerIn.sendSystemMessage(
                            Component.translatable("gt6.machine.basic.input_from_output_side.allow")
                                    .append(Component.translatable("gt6.creative.tank.fluid")));
                }
            }
            return InteractionResult.SUCCESS;
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new ImageWidget(4, 4, 82, 55, GuiTextures.DISPLAY))
                .addWidget(new LabelWidget(8, 8, "gt6.gui.fluid_amount"))
