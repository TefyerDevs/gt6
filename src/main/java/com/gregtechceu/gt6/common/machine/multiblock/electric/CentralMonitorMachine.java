...
import com.gregtechceu.gt6.api.pattern.*;
...
import com.gregtechceu.gt6.common.machine.trait.CentralMonitorLogic;
...
public class CentralMonitorMachine extends WorkableElectricMultiblockMachine
    ...
    public Widget createUIWidget() {
        ...
        infoWidget.setHoverTooltips(
                GTStringUtils.toImmutable(LangHandler.getSingleOrMultiLang("gt6.central_monitor.info_tooltip")));
        ...
        Consumer<MonitorGroup> openGroupConfig = (group) -> {
            ...
            groupConfig.addWidget(new LabelWidget(0, 5, () -> {
                ...
                return Component.translatable("gt6.central_monitor.gui.currently_editing", currentName).getString();
            }));
            for (int i = 0; i < 8; i++) {
        ...
        removeFromGroupButton.setButtonTexture(new TextTexture("gt6.central_monitor.gui.remove_from_group"));
        removeFromGroupButton.setVisible(false);
        ButtonWidget setTargetButton = new ButtonWidget(0, 15, 60, 20, null);
        setTargetButton.setButtonTexture(new TextTexture("gt6.central_monitor.gui.set_target"));
        ...
        createGroupButton.setOnPressCallback(click -> {
            MonitorGroup group = new MonitorGroup(
                    Component.translatable("gt6.gui.central_monitor.group_default_name", monitorGroups.size() + 1)
                            .getString());
        ...
        createGroupButton.setButtonTexture(new TextTexture("gt6.central_monitor.gui.create_group"));
        createGroupButton.setVisible(false);
                        ...
                        monitorGroups.forEach(group -> {
                            if (group.contains(component.getPos())) {
                                img.setHoverTooltips(
                                        Component.translatable("gt6.gui.central_monitor.group", group.getName()));
                            }
                        });
                    } else {
                        img.setHoverTooltips(Component.translatable("gt6.gui.central_monitor.group",
                                Component.translatable("gt6.gui.central_monitor.none")));
                    }
                };
    ...
    public @NotNull List<Component> getDebugInfo(Player player, int logLevel,
        ...
        return List.of(Component.translatable("gt6.central_monitor.size", leftDist, rightDist, upDist, downDist));
    }
