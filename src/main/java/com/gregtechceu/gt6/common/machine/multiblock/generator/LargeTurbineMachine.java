...
import com.gregtechceu.gt6.api.capability.ITurbineMachine;
    ...
    public void addDisplayText(List<Component> textList) {
        ...
        if (isFormed()) {
            ...
            if (rotorHolder != null && rotorHolder.getRotorEfficiency() > 0) {
                textList.add(Component.translatable("gt6.multiblock.turbine.rotor_speed",
                        FormattingUtil.formatNumbers(rotorHolder.getRotorSpeed()),
                        FormattingUtil.formatNumbers(rotorHolder.getMaxRotorHolderSpeed())));
                textList.add(Component.translatable("gt6.multiblock.turbine.efficiency",
                ...
                if (isActive()) {
                    textList.add(3, Component.translatable("gt6.multiblock.turbine.energy_per_tick",
                ...
                if (rotorDurability > MIN_DURABILITY_TO_WARN) {
                    textList.add(Component.translatable("gt6.multiblock.turbine.rotor_durability", rotorDurability));
                } else {
                    textList.add(Component.translatable("gt6.multiblock.turbine.rotor_durability", rotorDurability)
