        ...
        if (this.energyContainer.getEnergyStored() >= energyToConsume) {
            if (!getRecipeLogic().isWaiting()) {
                ...
                if (consumed == energyToConsume) {
                    ...
                    getRecipeLogic()
                            .setWaiting(Component.translatable("gt6.recipe_logic.insufficient_in")
                                    .append(": ").append(EURecipeCapability.CAP.getName()));
                }
            }
        } else {
            getRecipeLogic().setWaiting(Component.translatable("gt6.recipe_logic.insufficient_in").append(": ")
