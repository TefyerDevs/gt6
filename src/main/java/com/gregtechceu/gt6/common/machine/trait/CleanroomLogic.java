...
import com.gregtechceu.gt6.common.machine.multiblock.electric.CleanroomMachine;
        ...
        if (duration > 0) {
            ...
            if (maintenanceMachine == null || maintenanceMachine.getNumMaintenanceProblems() < 6 || zone != null) {
                ...
                if (!consumeEnergy()) {
                    ...
                    setWaiting(Component.translatable("gt6.recipe_logic.insufficient_in").append(": ")
