...
import com.gregtechceu.gt6.api.gui.editor.EditableMachineUI;
import com.gregtechceu.gt6.api.gui.editor.EditableUI;
...
public class MinerMachine extends WorkableTieredMachine
    ...
    protected static EditableUI<SlotWidget, MinerMachine> createBatterySlot() {
        return new EditableUI<>("battery_slot", SlotWidget.class, () -> {
            ...
            slotWidget.setHoverTooltips(LangHandler.getMultiLang("gt6.gui.charger_slot.tooltip",
    ...
    private void addDisplayText(@NotNull List<Component> textList) {
        ...
        textList.add(Component.translatable("gt6.machine.miner.startx", getRecipeLogic().getX()).append(" ")
                .append(Component.translatable("gt6.machine.miner.minex", getRecipeLogic().getMineX())));
        textList.add(Component.translatable("gt6.machine.miner.starty", getRecipeLogic().getY()).append(" ")
                .append(Component.translatable("gt6.machine.miner.miney", getRecipeLogic().getMineY())));
        textList.add(Component.translatable("gt6.machine.miner.startz", getRecipeLogic().getZ()).append(" ")
                .append(Component.translatable("gt6.machine.miner.minez", getRecipeLogic().getMineZ())));
        ...
        if (!drainInput(true))
            textList.add(Component.translatable("gt6.multiblock.large_miner.needspower")
                    .setStyle(Style.EMPTY.withColor(ChatFormatting.RED)));
    }
    ...
    protected InteractionResult onScrewdriverClick(Player playerIn, InteractionHand hand, Direction gridSide,
        ...
        if (!this.isActive()) {
            ...
            playerIn.sendSystemMessage(Component.translatable("gt6.multiblock.large_miner.errorradius"));
        }
