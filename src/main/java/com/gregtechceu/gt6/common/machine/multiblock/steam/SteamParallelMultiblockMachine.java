package com.gregtechceu.gt6.common.machine.multiblock.steam;
...
import com.gregtechceu.gt6.api.machine.steam.SteamEnergyRecipeHandler;
    ...
    public void addDisplayText(List<Component> textList) {
        ...
        if (isFormed()) {
            if (steamEnergy != null && steamEnergy.getCapacity() > 0) {
                ...
                textList.add(Component.translatable("gt6.multiblock.steam.steam_stored", steamStored,
            ...
            if (!isWorkingEnabled()) {
                ...
                if (maxParallels > 1) textList.add(Component.translatable("gt6.multiblock.parallel", maxParallels));
            ...
            if (recipeLogic.isWaiting()) {
                textList.add(Component.translatable("gt6.multiblock.steam.low_steam")
