...
public non-sealed class ArgonautsOwner extends MachineOwner {
    ...
    private static final Component displayName = Component.translatable("gt6.ownership.name.argonauts");
    ...
    public String getName() {
        ...
        return guild != null ? guild.displayName().getString() :
                Component.translatable("gt6.tooltip.status.trinary.unknown").getString();
    }
