...
import com.gregtechceu.gt6.common.block.FusionCasingBlock;
...
import static com.gregtechceu.gt6.api.recipe.OverclockingLogic.PERFECT_HALF_DURATION_FACTOR;
import static com.gregtechceu.gt6.api.recipe.OverclockingLogic.PERFECT_HALF_VOLTAGE_FACTOR;
...
public class FusionReactorMachine extends WorkableElectricMultiblockMachine implements ITieredMachine {
    ...
    public boolean onWorking() {
        ...
        if (recipe.data.contains("eu_to_start")) {
            ...
            // if the remaining energy needed is more than stored, do not run
            if (heatDiff > 0) {
                recipeLogic.setWaiting(Component.translatable("gt6.recipe_logic.insufficient_fuel"));
    ...
    public void addDisplayText(List<Component> textList) {
        ...
        if (isFormed()) {
            textList.add(Component.translatable("gt6.multiblock.fusion_reactor.energy",
                    this.energyContainer.getEnergyStored(), this.energyContainer.getEnergyCapacity()));
            textList.add(Component.translatable("gt6.multiblock.fusion_reactor.heat", heat));
        }
    }
    ...
    public static void addEUToStartLabel(GTRecipe recipe, WidgetGroup group) {
        ...
        group.addWidget(new LabelWidget(-8, group.getSizeHeight() - 10,
                LocalizationUtils.format("gt6.recipe.eu_to_start",
