...
public class CreativeEnergyContainerMachine extends TieredMachine implements ILaserContainer, IUIMachine {
    ...
    public ModularUI createUI(Player entityPlayer) {
        return new ModularUI(176, 166, this, entityPlayer)
                ...
                .widget(new LabelWidget(7, 32, "gt6.creative.energy.voltage"))
                ...
                .widget(new LabelWidget(7, 74, "gt6.creative.energy.amperage"))
                ...
                .widget(new SwitchWidget(85, 139, 77, 20, (clickData, value) -> {
                    ...
                    if (source) {
                        ...
                        new GuiTextureGroup(ResourceBorderTexture.BUTTON_COMMON,
                                new TextTexture("gt6.creative.energy.sink")),
                        new GuiTextureGroup(ResourceBorderTexture.BUTTON_COMMON,
                                new TextTexture("gt6.creative.energy.source")))
                        .setPressed(source))
