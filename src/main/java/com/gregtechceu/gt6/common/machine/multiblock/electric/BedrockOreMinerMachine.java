...
import com.gregtechceu.gt6.common.machine.trait.BedrockOreMinerLogic;
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (getRecipeLogic().getVeinMaterials() != null) {
                // Ore names
                textList.add(Component.translatable("gt6.multiblock.ore_rig.drilled_ores_list")
                ...
                for (var entry : drilledOres) {
                    ...
                    textList.add(Component.translatable("gt6.multiblock.ore_rig.drilled_ore_entry", fluidInfo)
                ...
                textList.add(Component.translatable("gt6.multiblock.ore_rig.ore_amount", amountInfo)
                        .withStyle(ChatFormatting.GRAY));
            } else {
                Component noOre = Component.translatable("gt6.multiblock.fluid_rig.no_fluid_in_area")
                        .withStyle(ChatFormatting.RED);
                textList.add(Component.translatable("gt6.multiblock.ore_rig.drilled_ores_list")
                        .withStyle(ChatFormatting.GREEN));
                textList.add(Component.translatable("gt6.multiblock.ore_rig.drilled_ore_entry", noOre)
                        .withStyle(ChatFormatting.GRAY));
            }
        } else {
