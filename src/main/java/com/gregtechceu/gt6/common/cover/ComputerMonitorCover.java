...
import com.gregtechceu.gt6.api.placeholder.MultiLineComponent;
import com.gregtechceu.gt6.api.placeholder.PlaceholderContext;
import com.gregtechceu.gt6.api.placeholder.PlaceholderHandler;
import com.gregtechceu.gt6.api.transfer.item.CustomItemStackHandler;
import com.gregtechceu.gt6.client.renderer.cover.CoverTextRenderer;
import com.gregtechceu.gt6.client.renderer.cover.IDynamicCoverRenderer;
    ...
    public Widget createUIWidget() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            formatStringInput.setHoverTooltips(GTStringUtils.toImmutable(
                    LangHandler.getMultiLang("gt6.gui.computer_monitor_cover.main_textbox_tooltip", i + 1)));
            int finalI = i;
            ...
            SlotWidget slot = new com.gregtechceu.gt6.api.gui.widget.SlotWidget(
                    itemStackHandler,
                    i,
            ...
            slot.setHoverTooltips(GTStringUtils
                    .toImmutable(LangHandler.getMultiLang("gt6.gui.computer_monitor_cover.slot_tooltip", i + 1)));
        ...
        for (int i = 0; i < 8; i++) {
            ...
            formatStringArgsInput.setHoverTooltips(GTStringUtils.toImmutable(
                    LangHandler.getMultiLang("gt6.gui.computer_monitor_cover.second_page_textbox_tooltip",
        ...
        updateIntervalInput
                .setHoverTooltips(Component.translatable("gt6.gui.computer_monitor_cover.update_interval"));
        mainPage.addWidget(updateIntervalInput);
        switchToFormatStringArgsPageButton
                .setHoverTooltips(Component.translatable("gt6.gui.computer_monitor_cover.edit_blank_placeholders"));
        switchBack.setHoverTooltips(Component.translatable("gt6.gui.computer_monitor_cover.edit_displayed_text"));
    ...
    private void update() {
        ...
        if (coverHolder.getOffsetTimer() % updateInterval == 0) {
            try {
                ...
                text = GTUtil
                        .list(Component.translatable("gt6.computer_monitor_cover.error.exception", e.getMessage()));
            }
        }
    }
