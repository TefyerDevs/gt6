...
import com.gregtechceu.gt6.api.cover.filter.FilterHandler;
import com.gregtechceu.gt6.api.cover.filter.FilterHandlers;
import com.gregtechceu.gt6.api.cover.filter.FluidFilter;
import com.gregtechceu.gt6.api.gui.widget.EnumSelectorWidget;
import com.gregtechceu.gt6.api.gui.widget.IntInputWidget;
import com.gregtechceu.gt6.api.gui.widget.NumberInputWidget;
import com.gregtechceu.gt6.api.machine.ConditionalSubscriptionHandler;
import com.gregtechceu.gt6.api.transfer.fluid.FluidHandlerDelegate;
import com.gregtechceu.gt6.api.transfer.fluid.IFluidHandlerModifiable;
import com.gregtechceu.gt6.api.transfer.fluid.ModifiableFluidHandlerWrapper;
import com.gregtechceu.gt6.common.cover.data.BucketMode;
...
public class PumpCover extends CoverBehavior implements IIOCover, IUICover, IControllable {
    ...
    private List<Component> getBucketModeTooltip(BucketMode mode, String langKey) {
        return List.of(
                Component.translatable(langKey).append(Component.translatable("gt6.gui.content.units.per_tick")));
    }
