...
import com.gregtechceu.gt6.api.data.chemical.material.event.MaterialEvent;
import com.gregtechceu.gt6.api.data.chemical.material.event.MaterialRegistryEvent;
...
import com.gregtechceu.gt6.api.data.worldgen.WorldGenLayers;
import com.gregtechceu.gt6.api.data.worldgen.generator.IndicatorGenerators;
import com.gregtechceu.gt6.api.data.worldgen.generator.VeinGenerators;
import com.gregtechceu.gt6.api.gui.factory.CoverUIFactory;
import com.gregtechceu.gt6.api.gui.factory.GTUIEditorFactory;
...
import com.gregtechceu.gt6.api.recipe.ingredient.*;
import com.gregtechceu.gt6.api.recipe.lookup.ingredient.*;
import com.gregtechceu.gt6.api.recipe.lookup.ingredient.fluid.*;
import com.gregtechceu.gt6.api.recipe.lookup.ingredient.item.*;
import com.gregtechceu.gt6.api.registry.GTRegistries;
import com.gregtechceu.gt6.common.data.*;
import com.gregtechceu.gt6.common.data.GTPlaceholders;
import com.gregtechceu.gt6.common.data.machines.GTMachineUtils;
import com.gregtechceu.gt6.common.data.materials.GTFoods;
import com.gregtechceu.gt6.common.item.tool.rotation.CustomBlockRotations;
...
import com.gregtechceu.gt6.core.mixins.registrate.AbstractRegistrateAccessor;
import com.gregtechceu.gt6.data.GregTechDatagen;
import com.gregtechceu.gt6.data.lang.MaterialLangGenerator;
import com.gregtechceu.gt6.data.loot.ChestGenHooks;
import com.gregtechceu.gt6.data.loot.DungeonLootLoader;
import com.gregtechceu.gt6.data.pack.GTDynamicDataPack;
import com.gregtechceu.gt6.data.pack.GTDynamicResourcePack;
import com.gregtechceu.gt6.data.pack.GTPackSource;
import com.gregtechceu.gt6.data.recipe.GTCraftingComponents;
import com.gregtechceu.gt6.forge.AlloyBlastPropertyAddition;
import com.gregtechceu.gt6.integration.ae2.GTAEPlaceholders;
import com.gregtechceu.gt6.integration.cctweaked.CCTweakedPlugin;
import com.gregtechceu.gt6.integration.create.GTCreateIntegration;
import com.gregtechceu.gt6.integration.kjs.GTCEuStartupEvents;
...
import com.gregtechceu.gt6.integration.map.WaypointManager;
import com.gregtechceu.gt6.integration.top.forge.TheOneProbePluginImpl;
import com.gregtechceu.gt6.utils.input.KeyBind;
import com.gregtechceu.gt6.utils.input.SyncedKeyMappings;
...
public class CommonProxy {
    ...
    public void registerPackFinders(AddPackFindersEvent event) {
        if (event.getPackType() == PackType.CLIENT_RESOURCES) {
            ...
            event.addRepositorySource(new GTPackSource("gt6:dynamic_assets",
                    event.getPackType(),
