...
public enum KeyBind {
    ...
    ARMOR_MODE_SWITCH("gt6.key.armor_mode_switch", KeyConflictContext.IN_GAME, InputConstants.KEY_M),
    ARMOR_HOVER("gt6.key.armor_hover", KeyConflictContext.IN_GAME, InputConstants.KEY_H),
    JETPACK_ENABLE("gt6.key.enable_jetpack", KeyConflictContext.IN_GAME, InputConstants.KEY_G),
    BOOTS_ENABLE("gt6.key.enable_boots", KeyConflictContext.IN_GAME, InputConstants.KEY_PERIOD),
    ARMOR_CHARGING("gt6.key.armor_charging", KeyConflictContext.IN_GAME, InputConstants.KEY_N),
    TOOL_AOE_CHANGE("gt6.key.tool_aoe_change", KeyConflictContext.IN_GAME, InputConstants.KEY_V),
    ACTION("gt6.key.action", KeyConflictContext.GUI, InputConstants.KEY_DELETE),
    ;
