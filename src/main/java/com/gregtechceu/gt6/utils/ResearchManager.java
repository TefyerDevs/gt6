...
public final class ResearchManager {
    ...
    public static class DataStickCopyScannerLogic implements GTRecipeType.ICustomRecipeLogic {
        ...
        public void buildRepresentativeRecipes() {
            ...
            copiedStick.setHoverName(Component.translatable("gt6.scanner.copy_stick_from"));
            ItemStack emptyStick = GTItems.TOOL_DATA_STICK.asStack();
            emptyStick.setHoverName(Component.translatable("gt6.scanner.copy_stick_empty"));
            ItemStack resultStick = GTItems.TOOL_DATA_STICK.asStack();
            resultStick.setHoverName(Component.translatable("gt6.scanner.copy_stick_to"));
